...
Public Class cls_coberturas_tocoa
    ...
    Public Function ListaUniverso() As DataView
        ...
        " CLIE05.CVE_VEND =  dbo.VEND05.CVE_VEND) AND (dbo.VEND05.CORREOE = 'TOC@A') " + _
        "GROUP BY dbo.VEND05.CVE_VEND, dbo.VEND05.NOMBRE,CORREOE "
    ...
    Public Function VentasXLinea(ByVal Fecha_Ini As Date, ByVal Fecha_Fin As Date, ByVal Linea As String, ByVal Clave As Integer) As DataView
        ...
        " (dbo.FACTF05.FECHA_DOC <= @Fin) AND (dbo.FACTF05.NUM_ALMA = 3)  " & _
        ...
        " (dbo.FACTD05.FECHA_DOC <= @Fin) AND (dbo.FACTD05.NUM_ALMA = 3) " & _
