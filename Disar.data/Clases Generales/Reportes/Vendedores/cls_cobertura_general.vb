...
Public Class cls_coberturas_general
    ...
    Public Function ListaUniverso() As DataView
        ...
        " CLIE05.CVE_VEND =  dbo.VEND05.CVE_VEND) and (dbo.VEND05.CORREOE IN('SR@C','SP@S','TOC@A','TG@U')) " & _
