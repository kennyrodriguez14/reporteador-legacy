...
Public Class cls_cajas_livsmart
    Dim Conexion As New clsconexion_consumo
    Public Function CajasLiv(ByVal DESDE As Date, ByVal HASTA As Date, ByVal SUCURSAL As String) As DataTable
        Dim ActualizarConexion As New SqlConnection(Conexion.CadenaSQL())
        Dim miComando As New SqlCommand("rptn_cajas_livsmart", ActualizarConexion)
