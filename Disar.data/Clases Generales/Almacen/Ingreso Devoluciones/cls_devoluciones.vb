...
Public Class cls_devoluciones
    Dim conexion As New cls_conexion_devoluciones_consumo
    Dim conexion_desc_dimosa As New cls_conexion_descuentos_tacticos_dimosa
    Dim conexion_consumo As New clsconexion_consumo
    Dim conexion_consumodimosa As New cls_conexion_DIMOSA
    Dim conexion_usuario As New clsConexion

    Dim conexion_consumoOPL As New cls_conexionOPL
    Dim conexion_desc_OPL As New cls_descuentos_tacticos_opl
    ...
    Public Function ListarAlmacenes_para_resumenDIMOSA()
        Dim actualizarconexion As New SqlConnection(conexion_consumodimosa.CadenaSQL)
        Dim query As New StringBuilder
    ...
    Public Function listar_conceptosDIMOSA()
        Dim actualizarconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim query As New StringBuilder
    ...
    Public Function listar_conceptosOPL()
        Dim actualizarconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim query As New StringBuilder
    ...
    Public Function listar_facturas_devoluciones2(ByVal clave As String, ByVal codigo As String)
        Dim miconexion As New SqlConnection(conexion.CadenaSQL)
        Dim comando As New SqlCommand("lista_facturas_devoluciones2", miconexion)
        comando.CommandType = CommandType.StoredProcedure
        miconexion.Open()
        comando.Parameters.Add(New SqlParameter("@CLAVE", SqlDbType.VarChar)).Value = clave
        comando.Parameters.Add(New SqlParameter("@CVE_CLPV", SqlDbType.VarChar)).Value = codigo
        Dim adaptador As New SqlDataAdapter(comando)
        Dim dt As New DataTable
        adaptador.Fill(dt)
        miconexion.Close()
    ...
    Public Function listar_facturas_devolucionesDimosa(ByVal clave As String)
        Dim miconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim comando As New SqlCommand("lista_facturas_devoluciones", miconexion)
        comando.CommandType = CommandType.StoredProcedure
        miconexion.Open()
        comando.Parameters.Add(New SqlParameter("@CLAVE", SqlDbType.VarChar)).Value = clave
    ...
    Public Function listar_facturas_devolucionesOPL(ByVal clave As String)
        Dim miconexion As New SqlConnection(conexion_desc_OPL.CadenaSQL)
        Dim comando As New SqlCommand("lista_facturas_devoluciones", miconexion)
        comando.CommandType = CommandType.StoredProcedure
        miconexion.Open()
        comando.Parameters.Add(New SqlParameter("@CLAVE", SqlDbType.VarChar)).Value = clave
    ...
    Public Function listar_facturas_devolucionesDimosa2(ByVal clave As String, ByVal codigo As String)
        Dim miconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim comando As New SqlCommand("lista_facturas_devoluciones2", miconexion)
        comando.CommandType = CommandType.StoredProcedure
        miconexion.Open()
        comando.Parameters.Add(New SqlParameter("@CLAVE", SqlDbType.VarChar)).Value = clave
        comando.Parameters.Add(New SqlParameter("@CVE_CPV", SqlDbType.VarChar)).Value = codigo
        Dim adaptador As New SqlDataAdapter(comando)
        Dim dt As New DataTable
        adaptador.Fill(dt)
        miconexion.Close()
    ...
    Public Function listar_facturas_devolucionesOPL2(ByVal clave As String, ByVal codigo As String)
        Dim miconexion As New SqlConnection(conexion_desc_OPL.CadenaSQL)
        Dim comando As New SqlCommand("lista_facturas_devoluciones2", miconexion)
        comando.CommandType = CommandType.StoredProcedure
        miconexion.Open()
    ...
    Public Function guardar_datos_local(ByVal dt_encabezado As DataTable, ByVal dt_partida As DataTable) As String
        ...
        Try
            ...
            query2.Append("INSERT INTO [tactical_discount_SanRafael].[dbo].[devol_encabezados] ")
            ...
            For i As Integer = 0 To dt_partida.Rows.Count - 1
                ...
                query3.Append("INSERT INTO [tactical_discount_SanRafael].[dbo].[devol_partidas] ")
    ...
    Public Function guardar_datos_local_aplicacion_android(ByVal dt_encabezado As DataTable, ByVal dt_partida As DataTable, ByVal empresa As String) As String
        Dim mitransacion As SqlTransaction
        Dim miconexion As New SqlConnection(conexion.CadenaSQL)
        Dim variable_error As String = ""
        miconexion.Open()
        ...
        Try
            ...
            Dim upd_aplicacion_hh As New StringBuilder
            upd_aplicacion_hh.Append("update PedidosHH_SANRAFAEL.dbo.devos_enca SET estatus = 'ENVIADA' WHERE numero_fac = @nf AND empresa = @empresa")
            Dim comand_upd_aplicacion As New SqlCommand(upd_aplicacion_hh.ToString, miconexion)
            comand_upd_aplicacion.Parameters.AddWithValue("@nf", dt_encabezado.Rows(0)(4))
            comand_upd_aplicacion.Parameters.AddWithValue("@empresa", empresa)
            comand_upd_aplicacion.Transaction = mitransacion
            comand_upd_aplicacion.ExecuteNonQuery()
    ...
    Public Function guardar_datos_local_aplicacion_android_DIMOSA(ByVal dt_encabezado As DataTable, ByVal dt_partida As DataTable, ByVal empresa As String) As String
        Dim mitransacion As SqlTransaction
        Dim miconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim variable_error As String = ""
        miconexion.Open()
        ...
        Try
            ...
            Dim query2 As New StringBuilder
            query2.Append("INSERT INTO [tactical_discount_DIMOSA].[dbo].[devol_encabezados] ")
            query2.Append("([CVE_INTERNA],[CVE_CLIE],[TIPO_PAGO],[CVE_VEND],[ALMACEN],[N_FACTURA],[FECHA_SAE] ")
            query2.Append(",[FECHA_ELABORACION],[CONCEPTO],[CVE_ENTREGADOR],[VEHICULO],[ENLAZADO],[ESTADO],[TIPO_CAMPLIB],[SERIE] ")
            query2.Append(",[FECHA_DOC],[FECHA_ENT],[FECHA_VEN],[CONDICION],[RFC],[AUTORIZA],[FOLIO],[AUTOANIO]) ")
            query2.Append("VALUES ")
            ...
            For i As Integer = 0 To dt_partida.Rows.Count - 1
                Dim query3 As New StringBuilder
                query3.Append("INSERT INTO [tactical_discount_DIMOSA].[dbo].[devol_partidas] ")
                query3.Append("([CVE_INTERNA],[NUM_PAR],[CVE_ART],[CANTIDAD], [PXRS], ")
                query3.Append("[PREC],[COST],[IMPU4],[DESC1], [NUM_ALM],[POLIT_APLI], ")
                query3.Append("[UNI_VENTA], [E_LTPD], [NUM_MOV], [FACT_CONV], [CON_LOTE])  ")
                query3.Append("VALUES(@CVE_INTERNA, @NUM_PAR, @CVE_ART, @CANTIDAD, @PXRS, ")
            ...
            Dim upd_aplicacion_hh As New StringBuilder
            upd_aplicacion_hh.Append("update SAP_HH_SANRAFAEL.dbo.devos_enca SET estatus = 'ENVIADA' WHERE numero_fac = @nf AND empresa = @empresa")
            Dim comand_upd_aplicacion As New SqlCommand(upd_aplicacion_hh.ToString, miconexion)
            comand_upd_aplicacion.Parameters.AddWithValue("@nf", dt_encabezado.Rows(0)(4))
            comand_upd_aplicacion.Parameters.AddWithValue("@empresa", empresa)
            comand_upd_aplicacion.Transaction = mitransacion
    ...
    Public Function guardar_datos_local_aplicacion_android_OPL(ByVal dt_encabezado As DataTable, ByVal dt_partida As DataTable, ByVal empresa As String) As String
        Dim mitransacion As SqlTransaction
        Dim miconexion As New SqlConnection(conexion_desc_OPL.CadenaSQL)
        Dim variable_error As String = ""
        miconexion.Open()
        ...
        Try
            ...
            Dim query2 As New StringBuilder
            query2.Append("INSERT INTO [tactical_discount_OPL].[dbo].[devol_encabezados] ")
            query2.Append("([CVE_INTERNA],[CVE_CLIE],[TIPO_PAGO],[CVE_VEND],[ALMACEN],[N_FACTURA],[FECHA_SAE] ")
            query2.Append(",[FECHA_ELABORACION],[CONCEPTO],[CVE_ENTREGADOR],[VEHICULO],[ENLAZADO],[ESTADO],[TIPO_CAMPLIB],[SERIE] ")
            query2.Append(",[FECHA_DOC],[FECHA_ENT],[FECHA_VEN],[CONDICION],[RFC],[AUTORIZA],[FOLIO],[AUTOANIO]) ")
            query2.Append("VALUES ")
            ...
            For i As Integer = 0 To dt_partida.Rows.Count - 1
                Dim query3 As New StringBuilder
                query3.Append("INSERT INTO [tactical_discount_OPL].[dbo].[devol_partidas] ")
                query3.Append("([CVE_INTERNA],[NUM_PAR],[CVE_ART],[CANTIDAD], [PXRS], ")
                query3.Append("[PREC],[COST],[IMPU4],[DESC1], [NUM_ALM],[POLIT_APLI], ")
                query3.Append("[UNI_VENTA], [E_LTPD], [NUM_MOV], [FACT_CONV], [CON_LOTE])  ")
                query3.Append("VALUES(@CVE_INTERNA, @NUM_PAR, @CVE_ART, @CANTIDAD, @PXRS, ")
    ...
    Public Function guardar_datos_local_dimosa(ByVal dt_encabezado As DataTable, ByVal dt_partida As DataTable) As String
        Dim mitransacion As SqlTransaction
        Dim miconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim variable_error As String = ""
        miconexion.Open()
    ...
    Public Function guardar_datos_local_OPL(ByVal dt_encabezado As DataTable, ByVal dt_partida As DataTable) As String
        Dim mitransacion As SqlTransaction
        Dim miconexion As New SqlConnection(conexion_desc_OPL.CadenaSQL)
        Dim variable_error As String = ""
        miconexion.Open()
    ...
    Public Function productos_factura(ByVal DOCTO As String) As DataTable
        ...
        query.Append("INNER JOIN IMPU05 ISV ON ISV.CVE_ESQIMPU = IV.CVE_ESQIMPU ")
    ...
    Public Function productos_factura_dimosa(ByVal DOCTO As String) As DataTable
        ...
        query.Append("INNER JOIN IMPU06 ISV ON ISV.CVE_ESQIMPU = IV.CVE_ESQIMPU ")
        query.Append("WHERE (PF.CVE_DOC = @DOCTO) ")
        Dim miconexion As New SqlConnection(conexion_consumodimosa.CadenaSQL)
        miconexion.Open()
        Dim micomando As New SqlCommand(query.ToString, miconexion)
        micomando.Parameters.AddWithValue("@DOCTO", DOCTO)
        Dim adaptador As New SqlDataAdapter(micomando)
    ...
    Public Function productos_factura_OPL(ByVal DOCTO As String) As DataTable
        ...
        query.Append("INNER JOIN IMPU08 ISV ON ISV.CVE_ESQIMPU = IV.CVE_ESQIMPU ")
        query.Append("WHERE (PF.CVE_DOC = @DOCTO) ")
        Dim miconexion As New SqlConnection(conexion_consumoOPL.CadenaSQL)
        miconexion.Open()
        Dim micomando As New SqlCommand(query.ToString, miconexion)
        micomando.Parameters.AddWithValue("@DOCTO", DOCTO)
        Dim adaptador As New SqlDataAdapter(micomando)
    ...
    Public Function get_fecha_limite() As Date
        ...
        query.Append("FROM SAE60EMPRE05.dbo.PARAM_FACTURA05 ")
        Dim miconexion As New SqlConnection(conexion.CadenaSQL)
        Dim micomando As New SqlCommand(query.ToString, miconexion)
        miconexion.Open()
    ...
    Public Function get_fecha_limite_DIMOSA() As Date
        Dim query As New StringBuilder
        query.Append("SELECT FCHCIERREDOCTOS ")
        query.Append("FROM SAE60EMPRE06.dbo.PARAM_FACTURA06 ")
        Dim miconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim micomando As New SqlCommand(query.ToString, miconexion)
        miconexion.Open()
    ...
    Public Function modificar_devolucion(ByVal dt_encabezado As DataTable, ByVal dt_partida As DataTable, ByVal docto As String) As String
        ...
        Try
            ...
            query_delete.Append("DELETE FROM [tactical_discount_SanRafael].[dbo].[devol_partidas] ")
    ...
    Public Function modificar_devolucionDIMOSA(ByVal dt_encabezado As DataTable, ByVal dt_partida As DataTable, ByVal docto As String) As String
        Dim mitransacion As SqlTransaction
        Dim miconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim variable_error As String = ""
        miconexion.Open()
        ...
        Try
            Dim query_delete As New StringBuilder
            query_delete.Append("DELETE FROM [tactical_discount_DIMOSA].[dbo].[devol_partidas] ")
            query_delete.Append("WHERE CVE_INTERNA = @CVE_INTERNA ")
    ...
    Public Function eliminar_devolucion(ByVal docto As String) As String
        ...
        Try
            Dim query3 As New StringBuilder
            query3.Append("DELETE FROM [tactical_discount_SanRafael].[dbo].[devol_encabezados] ")
    ...
    Public Function eliminar_devolucionDimosa(ByVal docto As String) As String
        Dim mitransacion As SqlTransaction
        Dim miconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim variable_error As String = ""
        miconexion.Open()
        ...
        Try
            Dim query3 As New StringBuilder
            query3.Append("DELETE FROM [tactical_discount_DIMOSA].[dbo].[devol_encabezados] ")
            query3.Append("WHERE CVE_INTERNA = @CVE_INTERNA ")
    ...
    Public Function eliminar_devolucionOPL(ByVal docto As String) As String
        Dim mitransacion As SqlTransaction
        Dim miconexion As New SqlConnection(conexion_desc_OPL.CadenaSQL)
        Dim variable_error As String = ""
        miconexion.Open()
        ...
        Try
            Dim query3 As New StringBuilder
            query3.Append("DELETE FROM [tactical_discount_OPL].[dbo].[devol_encabezados] ")
            query3.Append("WHERE CVE_INTERNA = @CVE_INTERNA ")
            ...
            Dim query_delete As New StringBuilder
            query_delete.Append("DELETE FROM [tactical_discount_OPL].[dbo].[devol_partidas] ")
            query_delete.Append("WHERE CVE_INTERNA = @CVE_INTERNA ")
    ...
    Public Function lista_encabezados_devolucionesDimosa(ByVal FECHA_INI As Date, ByVal ALMACEN As Integer, ByVal TIPO As String _
                                                   , ByVal RANGO_INI As String, ByVal RANGO_FIN As String, ByVal CVE_ART As String)
        Dim actualizarconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim micomando As New SqlCommand("rptn_devoluciones_reporteador", actualizarconexion)
        micomando.CommandType = CommandType.StoredProcedure
    ...
    Public Function lista_encabezados_devolucionesOPL(ByVal FECHA_INI As Date, ByVal ALMACEN As Integer, ByVal TIPO As String _
                                                   , ByVal RANGO_INI As String, ByVal RANGO_FIN As String, ByVal CVE_ART As String)
        Dim actualizarconexion As New SqlConnection(conexion_desc_OPL.CadenaSQL)
        Dim micomando As New SqlCommand("rptn_devoluciones_reporteador", actualizarconexion)
        micomando.CommandType = CommandType.StoredProcedure
        micomando.CommandTimeout = 2000
        micomando.Parameters.Add(New SqlParameter("@ALMACEN", SqlDbType.Int)).Value = ALMACEN
    ...
    Public Function ListarAlmacenesOPL()
        Dim actualizarconexion As New SqlConnection(conexion_consumoOPL.CadenaSQL)
        Dim query As New StringBuilder
    ...
    Public Function ListarAlmacenes2()
        ...
        query.Append("SELECT CVE_ALM AS 'ID', DESCR AS 'ALMACEN' ")
        query.Append("FROM SAE60Empre05.dbo.ALMACENES05 WHERE CVE_ALM NOT IN (7,8,9,10) ")
    ...
    Public Function ListarAlmacenes2Agro()
        Dim actualizarconexion As New SqlConnection(conexion_consumo.CadenaSQL)
        Dim query As New StringBuilder
    ...
    Public Function ListarAlmacenes2Dimosa()
        Dim actualizarconexion As New SqlConnection(conexion_consumodimosa.CadenaSQL)
        Dim query As New StringBuilder
    ...
    Public Function ListarAlmacenes2OPL()
        Dim actualizarconexion As New SqlConnection(conexion_consumoOPL.CadenaSQL)
        Dim query As New StringBuilder
    ...
    Public Function modificar_detalle_productos(ByVal dt_productos As DataTable, ByVal cve_art As String) As String
        ...
        Try
            For i As Integer = 0 To dt_productos.Rows.Count - 1
                ...
                query_upd_partidas.Append("UPDATE [tactical_discount_SanRafael].[dbo].[devol_partidas] ")
    ...
    Public Function modificar_detalle_productosDimosa(ByVal dt_productos As DataTable, ByVal cve_art As String) As String
        Dim mitransacion As SqlTransaction
        Dim miconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim variable_error As String = ""
        miconexion.Open()
        ...
        Try
            For i As Integer = 0 To dt_productos.Rows.Count - 1
                Dim query_upd_partidas As New StringBuilder
                query_upd_partidas.Append("UPDATE [tactical_discount_Dimosa].[dbo].[devol_partidas] ")
                query_upd_partidas.Append(" SET [CANTIDAD] = @CANTIDAD ")
                query_upd_partidas.Append(" WHERE [CVE_INTERNA] = @CVE_INTERNA AND ")
                query_upd_partidas.Append(" [NUM_PAR] = @NUM_PAR AND [CVE_ART] = @CVE_ART ")
    ...
    Public Function modificar_detalle_productosOPL(ByVal dt_productos As DataTable, ByVal cve_art As String) As String
        Dim mitransacion As SqlTransaction
        Dim miconexion As New SqlConnection(conexion_desc_OPL.CadenaSQL)
        Dim variable_error As String = ""
        miconexion.Open()
        ...
        Try
            For i As Integer = 0 To dt_productos.Rows.Count - 1
                Dim query_upd_partidas As New StringBuilder
                query_upd_partidas.Append("UPDATE [tactical_discount_OPL].[dbo].[devol_partidas] ")
                query_upd_partidas.Append(" SET [CANTIDAD] = @CANTIDAD ")
                query_upd_partidas.Append(" WHERE [CVE_INTERNA] = @CVE_INTERNA AND ")
                query_upd_partidas.Append(" [NUM_PAR] = @NUM_PAR AND [CVE_ART] = @CVE_ART ")
    ...
    Public Function validar_devos_enviadas(ByVal ALMACEN As Integer, ByVal FECHA As Date, ByVal RANGOI As String _
        ...
        query.Append("FROM	    [tactical_discount_SanRafael].[dbo].[devol_encabezados] devol  ")
    ...
    Public Function validar_devos_enviadasDIMOSA(ByVal ALMACEN As Integer, ByVal FECHA As Date, ByVal RANGOI As String _
                                     , ByVal RANGOF As String)
        Dim actualizarconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim query As New StringBuilder

        query.Append("SELECT    CVE_INTERNA AS 'Codigo Interno' ")
        query.Append("FROM	    [tactical_discount_DIMOSA].[dbo].[devol_encabezados] devol  ")
        query.Append("WHERE	    (ALMACEN = @ALMACEN) AND CONVERT(DATE,FECHA_SAE) = @FECHA ")
        query.Append("	        AND devol.ESTADO = 'ENVIADA' AND N_FACTURA >= @RANGOI  ")
        query.Append("	        AND N_FACTURA <= @RANGOF ")
        Dim micomando As New SqlCommand(query.ToString, actualizarconexion)
    ...
    Public Function validar_devos_enviadasOPL(ByVal ALMACEN As Integer, ByVal FECHA As Date, ByVal RANGOI As String _
                                     , ByVal RANGOF As String)
        Dim actualizarconexion As New SqlConnection(conexion_desc_OPL.CadenaSQL)
        Dim query As New StringBuilder

        query.Append("SELECT    CVE_INTERNA AS 'Codigo Interno' ")
        query.Append("FROM	    [tactical_discount_OPL].[dbo].[devol_encabezados] devol  ")
        query.Append("WHERE	    (ALMACEN = @ALMACEN) AND CONVERT(DATE,FECHA_SAE) = @FECHA ")
        query.Append("	        AND devol.ESTADO = 'ENVIADA' AND N_FACTURA >= @RANGOI  ")
        query.Append("	        AND N_FACTURA <= @RANGOF ")
        Dim micomando As New SqlCommand(query.ToString, actualizarconexion)
    ...
    Public Function guardar_recepcion_SAE(ByVal dt_encabezados As DataTable, ByVal rango_ini As String, ByVal rango_fin As String, _
        ...
        Try
            For i As Integer = 0 To dt_encabezados.Rows.Count - 1
                ...
                query_upd_encabezado.Append("UPDATE [tactical_discount_SanRafael].[dbo].[devol_encabezados] ")
                ...
                If dt_encabezados.Rows(i)(14).ToString.Substring(0, 1) = "T" Then
                    Dim query_factura As New StringBuilder()
                    query_factura.Append("SELECT CAN_TOT AS ST,DES_TOT AS DESCUENTO,IMP_TOT4 AS ISV,IMPORTE AS TOTAL,CVE_VEND, ")
                    query_factura.Append("ISNULL(CVE_PEDI,0) AS VEHICULO, FECHA_DOC,FECHA_ENT,FECHA_VEN,ISNULL(CONDICION,0) AS CONDICION, ")
                    query_factura.Append("NUM_ALMA AS ALMACEN,ISNULL(RFC,'') AS RFC, AUTORIZA, SERIE, FOLIO, AUTOANIO ")
                    query_factura.Append("FROM SAE60Empre05.dbo.FACTF05 F WHERE	CVE_DOC = @N_FACTURA ")
                    Dim cmd_select_DATOS_FACT As New SqlCommand(query_factura.ToString, miconexion)
                ...
                _query_get_MOTIVO.Append("FROM [SAE60Empre05].[dbo].[TBLCONTROL05] ")
                ...
                _query_INSERTMOTIVO.Append("INSERT INTO [SAE60Empre05].[dbo].[OBS_DOCF05] ")
                ...
                'CANCELAR NC O RECALCULAR NC

                'validar si tiene NC
                Dim query_get_nc As New StringBuilder
                query_get_nc.Append("SELECT	DISTINCT D.CVE_DOC,ISNULL(CTLPOL,0) AS CTLPOL, (SELECT CODIGO FROM ")
                query_get_nc.Append("	tactical_discount_SanRafael.dbo.encabezados E WHERE E.DOC_NC = D.CVE_DOC ")
                query_get_nc.Append("	COLLATE MODERN_SPANISH_CI_AS AND E.FACTURA = D.DOC_ANT COLLATE MODERN_SPANISH_CI_AS) AS REPO, ")
                query_get_nc.Append("	'NC' + CONVERT(VARCHAR,CONVERT(INT,SUBSTRING(D.CVE_DOC,11,8))) AS CARGOXDEV, ")
                query_get_nc.Append("	ISNULL((SELECT TIPO FROM tactical_discount_SanRafael.dbo.encabezados E WHERE E.DOC_NC = D.CVE_DOC  ")
                query_get_nc.Append("	COLLATE MODERN_SPANISH_CI_AS AND E.FACTURA = D.DOC_ANT COLLATE MODERN_SPANISH_CI_AS),'') AS TIPO, ")
                query_get_nc.Append("	IMPORTE ")
                query_get_nc.Append("FROM	SAE60Empre05.dbo.FACTD05 D INNER JOIN SAE60Empre05.dbo.PAR_FACTD05 PD ON PD.CVE_DOC = D.CVE_DOC ")
                query_get_nc.Append("WHERE	D.DOC_ANT = @DOC_ANT AND CVE_ART LIKE 'ZDEV%' AND D.STATUS <> 'C' ")
                Dim cmd_get_nc As New SqlCommand(query_get_nc.ToString, miconexion)
                cmd_get_nc.Transaction = mitransacion
                cmd_get_nc.Parameters.AddWithValue("@DOC_ANT", dt_encabezados.Rows(i)(1))
                Dim adaptador_nc As New SqlDataAdapter(cmd_get_nc)
                Dim dt_get_nc As New DataTable
                adaptador_nc.Fill(dt_get_nc)
                'fin validar si tiene NC

                If dt_get_nc.Rows.Count > 0 Then
                    'validar que no este contabilizada la NC
                    If dt_get_nc.Rows(0)(1) = "0" Then
                        ' si la nc esta contabilizada no se hace nada
                        'si la devolucion es total
                        If dt_encabezados.Rows(i)(14).ToString.Substring(0, 1) = "T" Then
                            Dim query2 As New StringBuilder
                            query2.Append("UPDATE SAE60Empre05.dbo.FACTD05 SET [STATUS] = 'C' WHERE CVE_DOC = @CVE_DOC")
                            Dim micomando2 As New SqlCommand(query2.ToString, miconexion)
                            micomando2.Parameters.AddWithValue("@CVE_DOC", dt_get_nc.Rows(0)(0))
                            micomando2.Transaction = mitransacion
                            micomando2.ExecuteNonQuery()
                            ...
                            micomando4.Parameters.AddWithValue("@DOCTO", dt_get_nc.Rows(0)(0))
                            micomando4.Transaction = mitransacion
                            micomando4.ExecuteNonQuery()

                            If dt_get_nc.Rows(0)(4).ToString().ToUpper = "CONTADO" Then
                                ...
                                micomando5.Parameters.AddWithValue("@DOCTO", dt_get_nc.Rows(0)(0))
                            ...
                            Else
                                ...
                                Dim micomando3 As New SqlCommand(query3.ToString, miconexion)
                                micomando3.Parameters.AddWithValue("@CLAVE", dt_encabezados.Rows(i)(3))
                                micomando3.Parameters.AddWithValue("@MONTO", dt_get_nc.Rows(0)(5))
                                micomando3.Transaction = mitransacion
                                micomando3.ExecuteNonQuery()
                            End If
                            ...
                            micomando6.Parameters.AddWithValue("@DOC_NC", dt_get_nc.Rows(0)(0))
                            micomando6.Parameters.AddWithValue("@CODIGO", dt_get_nc.Rows(0)(2))
                            micomando6.Parameters.AddWithValue("@ESTADO_SAE", "C")
                            micomando6.Transaction = mitransacion
                            micomando6.ExecuteNonQuery()
                            'fin si la devolucion es total
                        Else
                            'inicio si la devolucion es parcial
                            '"SELECT (TOT_PARTIDA - (TOT_PARTIDA * DESC1 / 100)) + TOTIMP4
                            '"FROM PAR_FACTD05 WHERE (CVE_DOC = '00-001-06-00000004')
                            'fin si la devolucion es parcial
                        End If
                        ...
                        DESCRIPCION = "Se Realizo automatico Nº de Credito: " + dt_get_nc.Rows(0)(0) + " Nº Factura: " + dt_encabezados.Rows(i)(1) + " Nº Local: " + dt_get_nc.Rows(0)(2)
                        miComando_bita.Parameters.AddWithValue("@ACCION", DESCRIPCION)
                        miComando_bita.ExecuteNonQuery()
                    End If
                    ' fin de validar si no esta contabilizada
                End If
                'FIN DE CANCELAR NC O RECALCULAR NC

                Dim _query_UPD_FACTF As New StringBuilder
                _query_UPD_FACTF.Append("UPDATE [SAE60Empre05].[dbo].[FACTF05] ")
                ...
                For index_partidas_devolucion As Integer = 0 To dt_select_partidas_devoluciones.Rows.Count - 1
                    ...
                    If dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(14) = "S" Then
                        ...
                        query_correlativo_lotes.Append("SELECT (ULT_CVE + 1) AS ULT_CVE FROM SAE60Empre05.dbo.TBLCONTROL05 WHERE (ID_TABLA = 67) ")
                    ...
                    _query_doctosig2.Append("INSERT INTO [SAE60Empre05].[dbo].[DOCTOSIGF05] ")
                    ...
                    _query_par_factd.Append("'N', ((SELECT ULT_CVE + 1 FROM SAE60EMPRE05.dbo.TBLCONTROL05 WHERE (ID_TABLA = 44))), @TOT_PARTIDA, 'S') ")
                    ...
                    _query_inve.Append("UPDATE SAE60EMPRE05.dbo.INVE05 ")
                    ...
                    _query_upda_mult.Append("UPDATE SAE60EMPRE05.dbo.MULT05 ")
                    ...
                    _query_minve.Append("INSERT INTO [SAE60Empre05].[dbo].[MINVE05] ")
                    ...
                    _query_minve.Append("(@CVE_ART,@ALMACEN,((SELECT ULT_CVE + 1 FROM SAE60EMPRE05.dbo.TBLCONTROL05 WHERE (ID_TABLA = 44))) ")
                    _query_minve.Append(",2,@FECHA_DOCU,'D',@REFER,@CLAVE_CLPV,@VEND ")
                    _query_minve.Append(",@CANT,0,@PRECIO,@COSTO,0,@UNI_VENTA,@E_LTPD, ")
                    _query_minve.Append(" ((SELECT EXIST FROM SAE60EMPRE05.dbo.INVE05 WHERE (CVE_ART = @CVE_ART))), ")
                    _query_minve.Append("((SELECT EXIST FROM SAE60EMPRE05.dbo.MULT05 WHERE (CVE_ART = @CVE_ART) AND CVE_ALM = @ALMACEN)), ")
                    _query_minve.Append("@FACTOR_CON,@FECHAELAB,0,(SELECT ULT_CVE+1 FROM SAE60EMPRE05.dbo.TBLCONTROL05 WHERE (ID_TABLA = 32)),1,'S', ")
                    ...
                    query_update_tabla_control_44.Append("UPDATE SAE60EMPRE05.dbo.TBLCONTROL05 ")
                    ...
                    query_update_tabla_control_32.Append("UPDATE SAE60EMPRE05.dbo.TBLCONTROL05 ")
                ...
                _query_control3.Append("UPDATE [SAE60Empre05].[dbo].[TBLCONTROL05] ")
            ...
            query_ins_recepcion.Append("INSERT INTO [tactical_discount_SanRafael].[dbo].[devol_recepciones] ")
    ...
    Public Function guardar_recepcion_SAE_DIMOSA(ByVal dt_encabezados As DataTable, ByVal rango_ini As String, ByVal rango_fin As String, _
                                          ByVal fecha As Date, ByVal almacen As Integer, ByVal usuario As String) As String
        Dim mitransacion As SqlTransaction
        Dim miconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim variable_error As String = ""
        ...
        Try
            ...
            For i As Integer = 0 To dt_encabezados.Rows.Count - 1
                'cambiar de estado a las devoluciones locales
                Dim query_upd_encabezado As New StringBuilder
                query_upd_encabezado.Append("UPDATE [tactical_discount_DIMOSA].[dbo].[devol_encabezados] ")
                query_upd_encabezado.Append("SET [ESTADO] = 'ENVIADA' ")
                query_upd_encabezado.Append("WHERE [CVE_INTERNA] = @CVE_INTERNA")
                Dim micomando_upd_encabezado As New SqlCommand(query_upd_encabezado.ToString, miconexion)
                micomando_upd_encabezado.Parameters.AddWithValue("@CVE_INTERNA", dt_encabezados.Rows(i)(0))
                ...
                Dim _query_get_MOTIVO As New StringBuilder
                _query_get_MOTIVO.Append("SELECT ULT_CVE + 1   ")
                _query_get_MOTIVO.Append("FROM [SAE60Empre06].[dbo].[TBLCONTROL06] ")
                _query_get_MOTIVO.Append("WHERE ([ID_TABLA] = 56)")
                Dim _cmd_GETMOTIVO As New SqlCommand(_query_get_MOTIVO.ToString, miconexion)
                _cmd_GETMOTIVO.Transaction = mitransacion
                Dim adaptador_MOTIVO As New SqlDataAdapter(_cmd_GETMOTIVO)
                ...
                Dim _query_INSERTMOTIVO As New StringBuilder
                _query_INSERTMOTIVO.Append("INSERT INTO [SAE60Empre06].[dbo].[OBS_DOCF06] ")
                _query_INSERTMOTIVO.Append("([CVE_OBS],[STR_OBS]) VALUES (@CVE_OBS,@STR_OBS) ")
                ...
                Dim query_get_nc As New StringBuilder
                query_get_nc.Append("SELECT	DISTINCT D.CVE_DOC,ISNULL(CTLPOL,0) AS CTLPOL, (SELECT CODIGO FROM ")
                query_get_nc.Append("	tactical_discount_Dimosa.dbo.encabezados E WHERE E.DOC_NC = D.CVE_DOC ")
                query_get_nc.Append("	COLLATE MODERN_SPANISH_CI_AS AND E.FACTURA = D.DOC_ANT COLLATE MODERN_SPANISH_CI_AS) AS REPO, ")
                query_get_nc.Append("	'NC' + CONVERT(VARCHAR,CONVERT(INT,SUBSTRING(D.CVE_DOC,11,8))) AS CARGOXDEV, ")
                query_get_nc.Append("	ISNULL((SELECT TIPO FROM tactical_discount_DIMOSA.dbo.encabezados E WHERE E.DOC_NC = D.CVE_DOC  ")
                query_get_nc.Append("	COLLATE MODERN_SPANISH_CI_AS AND E.FACTURA = D.DOC_ANT COLLATE MODERN_SPANISH_CI_AS),'') AS TIPO, ")
                query_get_nc.Append("	IMPORTE ")
                query_get_nc.Append("FROM	SAE60Empre06.dbo.FACTD06 D INNER JOIN SAE60Empre06.dbo.PAR_FACTD06 PD ON PD.CVE_DOC = D.CVE_DOC ")
                query_get_nc.Append("WHERE	D.DOC_ANT = @DOC_ANT AND CVE_ART LIKE 'ZDEV%' AND D.STATUS <> 'C' ")
                Dim cmd_get_nc As New SqlCommand(query_get_nc.ToString, miconexion)
                cmd_get_nc.Transaction = mitransacion
                cmd_get_nc.Parameters.AddWithValue("@DOC_ANT", dt_encabezados.Rows(i)(1))
                ...
                If dt_get_nc.Rows.Count > 0 Then
                    ...
                    If dt_get_nc.Rows(0)(1) = "0" Then
                        ...
                        miComando_bita.Parameters.AddWithValue("@MODULO", "Notas de Credito DIMOSA")
                        Dim DESCRIPCION As String = ""
                        DESCRIPCION = "Se Realizo automatico Nº de Credito: " + dt_get_nc.Rows(0)(0) + " Nº Factura: " + dt_encabezados.Rows(i)(1) + " Nº Local: " + dt_get_nc.Rows(0)(2)
                        miComando_bita.Parameters.AddWithValue("@ACCION", DESCRIPCION)
                        miComando_bita.ExecuteNonQuery()
                ...
                Dim _query_UPD_FACTF As New StringBuilder
                _query_UPD_FACTF.Append("UPDATE [SAE60Empre06].[dbo].[FACTF06] ")
                _query_UPD_FACTF.Append("SET [ENLAZADO] = @ENLAZADO, [TIP_DOC_E] = 'D', ")
                _query_UPD_FACTF.Append("[TIP_DOC_SIG] = 'D', [DOC_SIG] = @DOC_SIG ")
                _query_UPD_FACTF.Append("WHERE [CVE_DOC] = @CVE_DOC ")
                Dim cmd_UPD_FACTF As New SqlCommand(_query_UPD_FACTF.ToString, miconexion)
                ...
                For index_partidas_devolucion As Integer = 0 To dt_select_partidas_devoluciones.Rows.Count - 1
                    ...
                    If dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(14) = "S" Then
                        ...
                        Dim query_correlativo_lotes As New StringBuilder
                        query_correlativo_lotes.Append("SELECT (ULT_CVE + 1) AS ULT_CVE FROM SAE60Empre06.dbo.TBLCONTROL06 WHERE (ID_TABLA = 67) ")
                        Dim cmd_correlativo_lote As New SqlCommand(query_correlativo_lotes.ToString, miconexion)
                        cmd_correlativo_lote.Transaction = mitransacion
                        Dim adaptador_correlativo_lote As New SqlDataAdapter(cmd_correlativo_lote)
                        Dim dt_correlativo_lote As New DataTable
                    ...
                    _query_doctosig2.Append("INSERT INTO [SAE60Empre06].[dbo].[DOCTOSIGF06] ")
                    _query_doctosig2.Append("([TIP_DOC],[CVE_DOC],[ANT_SIG],[TIP_DOC_E] ")
                    _query_doctosig2.Append(",[CVE_DOC_E],[PARTIDA],[PART_E],[CANT_E]) ")
                    _query_doctosig2.Append("VALUES ")
                    _query_doctosig2.Append("('F',@CVE_DOC,'A', 'D',@CVE_DOC_E,@PARTIDA,0,0)")
                    ...
                    _query_par_factd.Append("@IMPU4, 0, 0, 0, 0, 0, 0, 0, @TOTIMP4, ")
                    _query_par_factd.Append("@DESC1, 0, 0, 0, 0, 'S', @NUM_ALM, @POLIT_APLI, 1, @UNI_VENTA,'P', 0,0, @E_LTPD,  ")
                    _query_par_factd.Append("'N', ((SELECT ULT_CVE + 1 FROM SAE60EMPRE06.dbo.TBLCONTROL06 WHERE (ID_TABLA = 44))), @TOT_PARTIDA, 'S') ")
                    ...
                    costo_prom_nuevo = ((existencias_viejas * costo_prom_viejo) + (dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(1)) _
                                        * dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(3)) / (existencias_viejas + _
                                            dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(1))
                    Dim _query_inve As New StringBuilder
                    _query_inve.Append("UPDATE SAE60EMPRE06.dbo.INVE06 ")
                    _query_inve.Append("SET [EXIST] = (EXIST + @NUEVA_EXISTENCIA), ")
                    _query_inve.Append("[VTAS_ANL_C] = (VTAS_ANL_C-@VTAS_ANL_C),[VTAS_ANL_M] = (VTAS_ANL_M-@VTAS_ANL_M), ")
                    _query_inve.Append("COSTO_PROM = @COSTO_PROM, ULT_COSTO = @ULT_COSTO ")
                    _query_inve.Append("WHERE [CVE_ART] = @CVE_ART ")
                    ...
                    Dim _query_upda_mult As New StringBuilder
                    _query_upda_mult.Append("UPDATE SAE60EMPRE06.dbo.MULT06 ")
                    _query_upda_mult.Append("SET [EXIST] = (EXIST + @NUEVA_EXISTENCIA) ")
                    _query_upda_mult.Append("WHERE  [CVE_ART] = @CVE_ART AND [CVE_ALM] = @CVE_ALM ")
                    Dim comando_upd_mult As New SqlCommand(_query_upda_mult.ToString, miconexion)
                    comando_upd_mult.Parameters.AddWithValue("@NUEVA_EXISTENCIA", dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(1))
                    ...
                    Dim _query_minve As New StringBuilder
                    _query_minve.Append("INSERT INTO [SAE60Empre06].[dbo].[MINVE06] ")
                    _query_minve.Append("([CVE_ART],[ALMACEN],[NUM_MOV],[CVE_CPTO],[FECHA_DOCU],[TIPO_DOC] ")
                    _query_minve.Append(",[REFER],[CLAVE_CLPV],[VEND],[CANT],[CANT_COST],[PRECIO],[COSTO] ")
                    _query_minve.Append(",[REG_SERIE],[UNI_VENTA],[E_LTPD],[EXIST_G] ")
                    _query_minve.Append(",[EXISTENCIA],[FACTOR_CON],[FECHAELAB],[CTLPOL],[CVE_FOLIO] ")
                    ...
                    _query_minve.Append(",[DESDE_INVE],[MOV_ENLAZADO]) ")
                    _query_minve.Append("VALUES ")
                    _query_minve.Append("(@CVE_ART,@ALMACEN,((SELECT ULT_CVE + 1 FROM SAE60EMPRE06.dbo.TBLCONTROL06 WHERE (ID_TABLA = 44))) ")
                    _query_minve.Append(",2,@FECHA_DOCU,'D',@REFER,@CLAVE_CLPV,@VEND ")
                    _query_minve.Append(",@CANT,0,@PRECIO,@COSTO,0,@UNI_VENTA,@E_LTPD, ")
                    _query_minve.Append(" ((SELECT EXIST FROM SAE60EMPRE06.dbo.INVE06 WHERE (CVE_ART = @CVE_ART))), ")
                    _query_minve.Append("((SELECT EXIST FROM SAE60EMPRE06.dbo.MULT06 WHERE (CVE_ART = @CVE_ART) AND CVE_ALM = @ALMACEN)), ")
                    _query_minve.Append("@FACTOR_CON,@FECHAELAB,0,(SELECT ULT_CVE+1 FROM SAE60EMPRE06.dbo.TBLCONTROL06 WHERE (ID_TABLA = 32)),1,'S', ")
                    _query_minve.Append("@COSTO_PROM_INI,@COSTO_PROM_FIN,@COSTO_PROM_GRAL,'N',@MOV_ENLAZADO) ")
                    ...
                    'actualizar los numeros de movimientos al inventario
                    Dim query_update_tabla_control_44 As New StringBuilder
                    query_update_tabla_control_44.Append("UPDATE SAE60EMPRE06.dbo.TBLCONTROL06 ")
                    query_update_tabla_control_44.Append("SET [ULT_CVE] = ULT_CVE + 1 ")
                    query_update_tabla_control_44.Append("WHERE (ID_TABLA = 44) ")
                    Dim micomando_upd_tabla_control44 As New SqlCommand(query_update_tabla_control_44.ToString, miconexion)
                    micomando_upd_tabla_control44.Transaction = mitransacion
                    ...
                    'actualizar los numeros de FOLIOS al inventario
                    Dim query_update_tabla_control_32 As New StringBuilder
                    query_update_tabla_control_32.Append("UPDATE SAE60EMPRE06.dbo.TBLCONTROL06 ")
                    query_update_tabla_control_32.Append("SET [ULT_CVE] = ULT_CVE + 1 ")
                    query_update_tabla_control_32.Append("WHERE (ID_TABLA = 32) ")
                    Dim micomando_upd_tabla_control32 As New SqlCommand(query_update_tabla_control_32.ToString, miconexion)
                    micomando_upd_tabla_control32.Transaction = mitransacion
                ...
                Dim _query_control3 As New StringBuilder
                _query_control3.Append("UPDATE [SAE60Empre06].[dbo].[TBLCONTROL06] ")
                _query_control3.Append(" SET [ULT_CVE] = ULT_CVE + 1 ")
                _query_control3.Append("WHERE [ID_TABLA] = 56 ")
                Dim _cmd_control3 As New SqlCommand(_query_control3.ToString, miconexion)
                _cmd_control3.Transaction = mitransacion
            ...
            'informacion LOCAL
            Dim query_ins_recepcion As New StringBuilder
            query_ins_recepcion.Append("INSERT INTO [tactical_discount_DIMOSA].[dbo].[devol_recepciones] ")
            query_ins_recepcion.Append("       ([RANGO_INI],[RANGO_FIN],[FECHA],[ALMACEN],[DEVOINI],[DEVOFIN]) ")
            query_ins_recepcion.Append(" VALUES (@RANGO_INI,@RANGO_FIN,@FECHA,@ALMACEN,@DEVOINI,@DEVOFIN) ")
            Dim comando_ins_recepcion As New SqlCommand(query_ins_recepcion.ToString, miconexion)
            comando_ins_recepcion.Parameters.AddWithValue("@RANGO_INI", rango_ini)
    ...
    Public Function guardar_recepcion_SAE_OPL(ByVal dt_encabezados As DataTable, ByVal rango_ini As String, ByVal rango_fin As String,
                                          ByVal fecha As Date, ByVal almacen As Integer, ByVal usuario As String) As String
        Dim mitransacion As SqlTransaction
        Dim miconexion As New SqlConnection(conexion_desc_OPL.CadenaSQL)
        Dim variable_error As String = ""
        ...
        Try
            ...
            For i As Integer = 0 To dt_encabezados.Rows.Count - 1
                'cambiar de estado a las devoluciones locales
                Dim query_upd_encabezado As New StringBuilder
                query_upd_encabezado.Append("UPDATE [tactical_discount_OPL].[dbo].[devol_encabezados] ")
                query_upd_encabezado.Append("SET [ESTADO] = 'ENVIADA' ")
                query_upd_encabezado.Append("WHERE [CVE_INTERNA] = @CVE_INTERNA")
                Dim micomando_upd_encabezado As New SqlCommand(query_upd_encabezado.ToString, miconexion)
                micomando_upd_encabezado.Parameters.AddWithValue("@CVE_INTERNA", dt_encabezados.Rows(i)(0))
                ...
                Dim _query_get_MOTIVO As New StringBuilder
                _query_get_MOTIVO.Append("SELECT ULT_CVE + 1   ")
                _query_get_MOTIVO.Append("FROM [SAE60Empre08].[dbo].[TBLCONTROL08] ")
                _query_get_MOTIVO.Append("WHERE ([ID_TABLA] = 56)")
                Dim _cmd_GETMOTIVO As New SqlCommand(_query_get_MOTIVO.ToString, miconexion)
                _cmd_GETMOTIVO.Transaction = mitransacion
                Dim adaptador_MOTIVO As New SqlDataAdapter(_cmd_GETMOTIVO)
                ...
                Dim _query_INSERTMOTIVO As New StringBuilder
                _query_INSERTMOTIVO.Append("INSERT INTO [SAE60Empre08].[dbo].[OBS_DOCF08] ")
                _query_INSERTMOTIVO.Append("([CVE_OBS],[STR_OBS]) VALUES (@CVE_OBS,@STR_OBS) ")
                ...
                Dim query_get_nc As New StringBuilder
                query_get_nc.Append("SELECT	DISTINCT D.CVE_DOC,ISNULL(CTLPOL,0) AS CTLPOL, (SELECT CODIGO FROM ")
                query_get_nc.Append("	tactical_discount_OPL.dbo.encabezados E WHERE E.DOC_NC = D.CVE_DOC ")
                query_get_nc.Append("	COLLATE MODERN_SPANISH_CI_AS AND E.FACTURA = D.DOC_ANT COLLATE MODERN_SPANISH_CI_AS) AS REPO, ")
                query_get_nc.Append("	'NC' + CONVERT(VARCHAR,CONVERT(INT,SUBSTRING(D.CVE_DOC,11,8))) AS CARGOXDEV, ")
                query_get_nc.Append("	ISNULL((SELECT TIPO FROM tactical_discount_OPL.dbo.encabezados E WHERE E.DOC_NC = D.CVE_DOC  ")
                query_get_nc.Append("	COLLATE MODERN_SPANISH_CI_AS AND E.FACTURA = D.DOC_ANT COLLATE MODERN_SPANISH_CI_AS),'') AS TIPO, ")
                query_get_nc.Append("	IMPORTE ")
                query_get_nc.Append("FROM	SAE60Empre08.dbo.FACTD08 D INNER JOIN SAE60Empre08.dbo.PAR_FACTD08 PD ON PD.CVE_DOC = D.CVE_DOC ")
                query_get_nc.Append("WHERE	D.DOC_ANT = @DOC_ANT AND CVE_ART LIKE 'ZDEV%' AND D.STATUS <> 'C' ")
                Dim cmd_get_nc As New SqlCommand(query_get_nc.ToString, miconexion)
                cmd_get_nc.Transaction = mitransacion
                cmd_get_nc.Parameters.AddWithValue("@DOC_ANT", dt_encabezados.Rows(i)(1))
                ...
                If dt_get_nc.Rows.Count > 0 Then
                    ...
                    If dt_get_nc.Rows(0)(1) = "0" Then
                        ...
                        miComando_bita.Parameters.AddWithValue("@MODULO", "Notas de Credito OPL")
                        Dim DESCRIPCION As String = ""
                        DESCRIPCION = "Se Realizo automatico Nº de Credito: " + dt_get_nc.Rows(0)(0) + " Nº Factura: " + dt_encabezados.Rows(i)(1) + " Nº Local: " + dt_get_nc.Rows(0)(2)
                        miComando_bita.Parameters.AddWithValue("@ACCION", DESCRIPCION)
                        miComando_bita.ExecuteNonQuery()
                ...
                Dim _query_UPD_FACTF As New StringBuilder
                _query_UPD_FACTF.Append("UPDATE [SAE60Empre08].[dbo].[FACTF08] ")
                _query_UPD_FACTF.Append("SET [ENLAZADO] = @ENLAZADO, [TIP_DOC_E] = 'D', ")
                _query_UPD_FACTF.Append("[TIP_DOC_SIG] = 'D', [DOC_SIG] = @DOC_SIG ")
                _query_UPD_FACTF.Append("WHERE [CVE_DOC] = @CVE_DOC ")
                Dim cmd_UPD_FACTF As New SqlCommand(_query_UPD_FACTF.ToString, miconexion)
                ...
                For index_partidas_devolucion As Integer = 0 To dt_select_partidas_devoluciones.Rows.Count - 1
                    ...
                    If dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(14) = "S" Then
                        Dim query_select_LOTE As New StringBuilder
                        query_select_LOTE.Append(" SELECT REG_LTPD, PXRS FROM SAE60Empre08.dbo.ENLACE_LTPD08 WHERE E_LTPD = @LOTE")
                        Dim cmd_select_LOTE As New SqlCommand(query_select_LOTE.ToString, miconexion)
                        cmd_select_LOTE.Parameters.AddWithValue("@LOTE", dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(10))
                        cmd_select_LOTE.Transaction = mitransacion
                        Dim adaptador_select_LOTE As New SqlDataAdapter(cmd_select_LOTE)
                        ...
                        Dim query_ltpd As New StringBuilder
                        query_ltpd.Append("UPDATE [SAE60Empre08].[dbo].[LTPD08] ")
                        query_ltpd.Append("SET [CANTIDAD] = [CANTIDAD] + @CANTIDAD ")
                        query_ltpd.Append("WHERE [CVE_ART] = @CVE_ART AND [CVE_ALM] = @CVE_ALM ")
                        query_ltpd.Append(" AND [REG_LTPD] = @REG_LTPD ")
                        Dim comando_ltpd As New SqlCommand(query_ltpd.ToString, miconexion)
                        ...
                        Dim query_correlativo_lotes As New StringBuilder
                        query_correlativo_lotes.Append("SELECT (ULT_CVE + 1) AS ULT_CVE FROM SAE60Empre08.dbo.TBLCONTROL08 WHERE (ID_TABLA = 67) ")
                        Dim cmd_correlativo_lote As New SqlCommand(query_correlativo_lotes.ToString, miconexion)
                        cmd_correlativo_lote.Transaction = mitransacion
                        Dim adaptador_correlativo_lote As New SqlDataAdapter(cmd_correlativo_lote)
                        Dim dt_correlativo_lote As New DataTable
                        ...
                        Dim query_UPD_enlace_ltpd As New StringBuilder
                        query_UPD_enlace_ltpd.Append("UPDATE [SAE60Empre08].[dbo].[ENLACE_LTPD08] ")
                    ...
                    _query_doctosig2.Append("INSERT INTO [SAE60Empre08].[dbo].[DOCTOSIGF08] ")
                    _query_doctosig2.Append("([TIP_DOC],[CVE_DOC],[ANT_SIG],[TIP_DOC_E] ")
                    _query_doctosig2.Append(",[CVE_DOC_E],[PARTIDA],[PART_E],[CANT_E]) ")
                    _query_doctosig2.Append("VALUES ")
                    _query_doctosig2.Append("('F',@CVE_DOC,'A', 'D',@CVE_DOC_E,@PARTIDA,0,0)")
                    ...
                    _query_par_factd.Append("@IMPU4, 0, 0, 0, 0, 0, 0, 0, @TOTIMP4, ")
                    _query_par_factd.Append("@DESC1, 0, 0, 0, 0, 'S', @NUM_ALM, @POLIT_APLI, 1, @UNI_VENTA,'P', 0,0, @E_LTPD,  ")
                    _query_par_factd.Append("'N', ((SELECT ULT_CVE + 1 FROM SAE60EMPRE08.dbo.TBLCONTROL08 WHERE (ID_TABLA = 44))), @TOT_PARTIDA, 'S') ")
                    ...
                    Dim costo_prom_nuevo As Double = 0
                    costo_prom_nuevo = ((existencias_viejas * costo_prom_viejo) + (dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(1)) _
                                        * dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(3)) / (existencias_viejas +
                                            dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(1))
                    Dim _query_inve As New StringBuilder
                    _query_inve.Append("UPDATE SAE60EMPRE08.dbo.INVE08 ")
                    _query_inve.Append("SET [EXIST] = (EXIST + @NUEVA_EXISTENCIA), ")
                    _query_inve.Append("[VTAS_ANL_C] = (VTAS_ANL_C-@VTAS_ANL_C),[VTAS_ANL_M] = (VTAS_ANL_M-@VTAS_ANL_M), ")
                    _query_inve.Append("COSTO_PROM = @COSTO_PROM, ULT_COSTO = @ULT_COSTO ")
                    _query_inve.Append("WHERE [CVE_ART] = @CVE_ART ")
                    Dim comando_update_inve As New SqlCommand(_query_inve.ToString(), miconexion)
                    comando_update_inve.Parameters.AddWithValue("@NUEVA_EXISTENCIA",
                                                                dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(1))
                    comando_update_inve.Parameters.AddWithValue("@VTAS_ANL_C", dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(1))
                    comando_update_inve.Parameters.AddWithValue("@VTAS_ANL_M", dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(12))
                    comando_update_inve.Parameters.AddWithValue("@CVE_ART", dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(0))
                    ...
                    Dim _query_upda_mult As New StringBuilder
                    _query_upda_mult.Append("UPDATE SAE60EMPRE08.dbo.MULT08 ")
                    _query_upda_mult.Append("SET [EXIST] = (EXIST + @NUEVA_EXISTENCIA) ")
                    _query_upda_mult.Append("WHERE  [CVE_ART] = @CVE_ART AND [CVE_ALM] = @CVE_ALM ")
                    Dim comando_upd_mult As New SqlCommand(_query_upda_mult.ToString, miconexion)
                    comando_upd_mult.Parameters.AddWithValue("@NUEVA_EXISTENCIA", dt_select_partidas_devoluciones.Rows(index_partidas_devolucion)(1))
                    ...
                    Dim _query_minve As New StringBuilder
                    _query_minve.Append("INSERT INTO [SAE60Empre08].[dbo].[MINVE08] ")
                    _query_minve.Append("([CVE_ART],[ALMACEN],[NUM_MOV],[CVE_CPTO],[FECHA_DOCU],[TIPO_DOC] ")
                    _query_minve.Append(",[REFER],[CLAVE_CLPV],[VEND],[CANT],[CANT_COST],[PRECIO],[COSTO] ")
                    _query_minve.Append(",[REG_SERIE],[UNI_VENTA],[E_LTPD],[EXIST_G] ")
                    _query_minve.Append(",[EXISTENCIA],[FACTOR_CON],[FECHAELAB],[CTLPOL],[CVE_FOLIO] ")
                    ...
                    _query_minve.Append(",[DESDE_INVE],[MOV_ENLAZADO]) ")
                    _query_minve.Append("VALUES ")
                    _query_minve.Append("(@CVE_ART,@ALMACEN,((SELECT ULT_CVE + 1 FROM SAE60EMPRE08.dbo.TBLCONTROL08 WHERE (ID_TABLA = 44))) ")
                    _query_minve.Append(",2,@FECHA_DOCU,'D',@REFER,@CLAVE_CLPV,@VEND ")
                    _query_minve.Append(",@CANT,0,@PRECIO,@COSTO,0,@UNI_VENTA,@E_LTPD, ")
                    _query_minve.Append(" ((SELECT EXIST FROM SAE60EMPRE08.dbo.INVE08 WHERE (CVE_ART = @CVE_ART))), ")
                    _query_minve.Append("((SELECT EXIST FROM SAE60EMPRE08.dbo.MULT08 WHERE (CVE_ART = @CVE_ART) AND CVE_ALM = @ALMACEN)), ")
                    _query_minve.Append("@FACTOR_CON,@FECHAELAB,0,(SELECT ULT_CVE+1 FROM SAE60EMPRE08.dbo.TBLCONTROL08 WHERE (ID_TABLA = 32)),1,'S', ")
                    _query_minve.Append("@COSTO_PROM_INI,@COSTO_PROM_FIN,@COSTO_PROM_GRAL,'N',@MOV_ENLAZADO) ")
                    ...
                    'actualizar los numeros de movimientos al inventario
                    Dim query_update_tabla_control_44 As New StringBuilder
                    query_update_tabla_control_44.Append("UPDATE SAE60EMPRE08.dbo.TBLCONTROL08 ")
                    query_update_tabla_control_44.Append("SET [ULT_CVE] = ULT_CVE + 1 ")
                    query_update_tabla_control_44.Append("WHERE (ID_TABLA = 44) ")
                    Dim micomando_upd_tabla_control44 As New SqlCommand(query_update_tabla_control_44.ToString, miconexion)
                    micomando_upd_tabla_control44.Transaction = mitransacion
                    ...
                    'actualizar los numeros de FOLIOS al inventario
                    Dim query_update_tabla_control_32 As New StringBuilder
                    query_update_tabla_control_32.Append("UPDATE SAE60EMPRE08.dbo.TBLCONTROL08 ")
                    query_update_tabla_control_32.Append("SET [ULT_CVE] = ULT_CVE + 1 ")
                    query_update_tabla_control_32.Append("WHERE (ID_TABLA = 32) ")
                    Dim micomando_upd_tabla_control32 As New SqlCommand(query_update_tabla_control_32.ToString, miconexion)
                    micomando_upd_tabla_control32.Transaction = mitransacion
                ...
                Dim _query_control3 As New StringBuilder
                _query_control3.Append("UPDATE [SAE60Empre08].[dbo].[TBLCONTROL08] ")
                _query_control3.Append(" SET [ULT_CVE] = ULT_CVE + 1 ")
                _query_control3.Append("WHERE [ID_TABLA] = 56 ")
                Dim _cmd_control3 As New SqlCommand(_query_control3.ToString, miconexion)
                _cmd_control3.Transaction = mitransacion
            ...
            'informacion LOCAL
            Dim query_ins_recepcion As New StringBuilder
            query_ins_recepcion.Append("INSERT INTO [tactical_discount_OPL].[dbo].[devol_recepciones] ")
            query_ins_recepcion.Append("       ([RANGO_INI],[RANGO_FIN],[FECHA],[ALMACEN],[DEVOINI],[DEVOFIN]) ")
            query_ins_recepcion.Append(" VALUES (@RANGO_INI,@RANGO_FIN,@FECHA,@ALMACEN,@DEVOINI,@DEVOFIN) ")
            Dim comando_ins_recepcion As New SqlCommand(query_ins_recepcion.ToString, miconexion)
            comando_ins_recepcion.Parameters.AddWithValue("@RANGO_INI", rango_ini)
    ...
    Public Function ListarfoliosDIMOSA(ByVal ALMACEN As Integer)
        Dim actualizarconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim query As New StringBuilder

        query.Append("cargar_folios_dev")
    ...
    Public Function ListarfoliosOPL(ByVal ALMACEN As Integer)
        Dim actualizarconexion As New SqlConnection(conexion_desc_OPL.CadenaSQL)
        Dim query As New StringBuilder
    ...
    Public Function Validar_devolucionesDIMOSA(ByVal FACTURA As String)
        Dim actualizarconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim query As New StringBuilder
    ...
    Public Function Validar_devolucionesOPL(ByVal FACTURA As String)
        Dim actualizarconexion As New SqlConnection(conexion_desc_OPL.CadenaSQL)
        Dim query As New StringBuilder
    ...
    Public Function Detalle_DevolucionesDIMOSA(ByVal CLAVE As String)
        Dim actualizarconexion As New SqlConnection(conexion_desc_dimosa.CadenaSQL)
        Dim query As New StringBuilder
    ...
    Public Function Detalle_DevolucionesOPL(ByVal CLAVE As String)
        Dim actualizarconexion As New SqlConnection(conexion_desc_OPL.CadenaSQL)
        Dim query As New StringBuilder
    ...
    Public Function cargar_devos_entrega(ByVal FECHA As Date, ByVal TIPO As String, ByVal ENTREGADOR As String, ByVal EMPRESA As String, ByVal FACTURA As String)

        Dim actualizarconexion As New SqlConnection(conexion.CadenaSQL)
            Dim query As New StringBuilder

        query.Append("rpt_plan_de_carga_carga_devos")

        Dim micomando As New SqlCommand(query.ToString, actualizarconexion)
        micomando.CommandTimeout = 4000
        micomando.CommandType = CommandType.StoredProcedure
            micomando.Parameters.AddWithValue("@FECHA", FECHA)
