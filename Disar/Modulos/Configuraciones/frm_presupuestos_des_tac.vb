Imports Disar.data
Public Class frm_presupuestos_des_tac
    Dim modo As String
    Dim Conexion As New cls_descuentos_tacticos
    Private Sub frm_presupuestos_des_tac_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ModificarToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ModificarToolStripMenuItem.Click
        Try
            ...
            txt_valor.Text = 0 'grd_presupuestos.CurrentRow.Cells(4).Value
