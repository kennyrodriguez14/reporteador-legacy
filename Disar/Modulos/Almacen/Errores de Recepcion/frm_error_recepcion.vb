...
Public Class frm_error_recepcion
    ...
    Private Sub NuevoToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NuevoToolStripMenuItem.Click
        FormErrorFormatoNuevo.Close()
        FormErrorFormatoNuevo.ShowDialog()
        'Limpiar()
    ...
    Sub Guardar()
        Try
            conexion.InsertErrorProv(cmbDia.Value.Date, cmbResponsable.SelectedValue, Val(txtcantidad.Text), txtcodigo_apartado.Text, txtcodigo_reportado.Text, cmbSolucion.SelectedValue, cmb_almacen_ins.SelectedValue, Cbox_Sucursal.SelectedValue, ComboProveedorEnvia.SelectedValue, ComboProveedorEnvia.Text)
    ...
    Sub cargar()
        Try
            If Cbox_Sucursal.Text = "SAN RAFAEL" Then
                grdDatos.DataSource = conexion.GetErrorRecepcion(inicio.Value.Date, fin.Value.Date, cmb_sucursal_rpt.SelectedValue)
            ElseIf Cbox_Sucursal.Text = "DIMOSA" Then
                grdDatos.DataSource = conexion.GetErrorRecepcionDimosa(inicio.Value.Date, fin.Value.Date, cmb_sucursal_rpt.SelectedValue)
            End If
    ...
    Sub Cargar_almacen()
        If Cbox_Sucursal.Text = "SAN RAFAEL" Then
            ...
            ComboProveedores.DataSource = conexion.ProveedoresSanRafael
            ComboProveedores.ValueMember = "CLAVE"
        ...
        ElseIf Cbox_Sucursal.Text = "DIMOSA" Then
            ...
            ComboProveedorEnvia.DataSource = conexion.ProveedoresSanRafael
            ComboProveedorEnvia.ValueMember = "CLAVE"
            ComboProveedorEnvia.DisplayMember = "NOMBRE"
            ComboProveedorEnvia.DataSource = conexion.ProveedoresSanRafael
            ComboProveedorEnvia.ValueMember = "CLAVE"
            ComboProveedorEnvia.DisplayMember = "NOMBRE"
