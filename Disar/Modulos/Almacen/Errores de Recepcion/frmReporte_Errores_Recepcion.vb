Imports Disar.data
Public Class FrmReporte_Errores_Recepcion
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            grd_listado.DataSource = conexion.ReporteErrores(cmFechaIni.Value.Date, cmbFin.Value.Date, cmb_almacen.SelectedValue, "DETALLE", cmb_empresa.Text)
            grd_encabezado.DataSource = conexion.ReporteErrores(cmFechaIni.Value.Date, cmbFin.Value.Date, cmb_almacen.SelectedValue, "ENCABEZADO", cmb_empresa.Text)
        Catch ex As Exception
