...
Public Class frm_guia_remision
    ...
    Sub cargar_entradas()
        Try
            If lbl_empresa.Text = "CONSUMO" Then
                ...
                cmb_concepto_entrada.SelectedValue = 7
            ElseIf lbl_empresa.Text = "SR AGRO" Then
                cmb_concepto_entrada.DataSource = remisiones.conceptos_entradas_sragro()
                cmb_concepto_entrada.DisplayMember = "DESCRIPCION"
                cmb_concepto_entrada.ValueMember = "CONCEPTO"
                cmb_concepto_entrada.SelectedValue = 7
            ElseIf lbl_empresa.Text = "FLOTA" Then
                cmb_concepto_entrada.DataSource = remisiones.conceptos_entradas_flota()
                cmb_concepto_entrada.DisplayMember = "DESCRIPCION"
                cmb_concepto_entrada.ValueMember = "CONCEPTO"
                cmb_concepto_entrada.SelectedValue = 7
            End If
    ...
    Sub cargar_salidas()
        Try
            If lbl_empresa.Text = "CONSUMO" Then
                ...
                cmb_concepto_salida.SelectedValue = 58
            ElseIf lbl_empresa.Text = "SR AGRO" Then
                ...
                cmb_concepto_salida.SelectedValue = 58
            ElseIf lbl_empresa.Text = "FLOTA" Then
                cmb_concepto_salida.DataSource = remisiones.conceptos_salidas_flota()
                cmb_concepto_salida.DisplayMember = "DESCRIPCION"
                cmb_concepto_salida.ValueMember = "CONCEPTO"
                cmb_concepto_salida.SelectedValue = 58
            End If
    ...
    Private Sub btn__Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_cancelar.Click
        Me.Close()
    End Sub
            ...
            If Val(TxtViajes.Text) > 0 Then
                If validador2 = 0 Then
                    If validador = 0 Then
                        ...
                        fila(2) = cmb_destino.SelectedValue
                        ...
                        If cmb_otro_destino.Checked = True Then
                            ...
                            If lbl_empresa.Text = "CONSUMO" Then
                                fallo = remisiones.INSERTAR_DESTINO_EXTERNO(dt, dt2, txt_destino.Text, txt_rtn.Text, txt_direccion.Text, _
                                        otro_transportista, otro_vehiculo, _txt_otro_transportista.Text, txt_rtn_otro_transportista.Text, _
                                        txt_marca_vehiculo.Text, txt_nplaca_vehiculo.Text, _Inicio.lblUsuario.Text, Val(TxtViajes.Text), TxtViajesRecomendados.Text)
                            ElseIf lbl_empresa.Text = "SR AGRO" Then
                                fallo = remisiones.INSERTAR_DESTINO_EXTERNO_sragro(dt, dt2, txt_destino.Text, txt_rtn.Text, txt_direccion.Text, _
                                       otro_transportista, otro_vehiculo, _txt_otro_transportista.Text, txt_rtn_otro_transportista.Text, _
                                        txt_marca_vehiculo.Text, txt_nplaca_vehiculo.Text, _Inicio.lblUsuario.Text, Val(TxtViajes.Text), TxtViajesRecomendados.Text)
                            ElseIf lbl_empresa.Text = "DIMOSA" Then
                                fallo = remisiones.INSERTAR_DESTINO_EXTERNO_DIMOSA(dt, dt2, txt_destino.Text, txt_rtn.Text, txt_direccion.Text, _
                                        otro_transportista, otro_vehiculo, _txt_otro_transportista.Text, txt_rtn_otro_transportista.Text, _
                                        txt_marca_vehiculo.Text, txt_nplaca_vehiculo.Text, _Inicio.lblUsuario.Text, Val(TxtViajes.Text), TxtViajesRecomendados.Text)
                            ElseIf lbl_empresa.Text = "FLOTA" Then
                                MsgBox("No se puede colocar un destino externo en una remisión de FLOTA", MsgBoxStyle.Information, "ATENCIÓN")
                            End If
                        ...
                        Else
                            ...
                            If lbl_empresa.Text = "CONSUMO" Then
                                fallo = remisiones.NUEVASOLICITUDPROD(dt, dt2, otro_transportista, otro_vehiculo, _txt_otro_transportista.Text, _
                                                        txt_rtn_otro_transportista.Text, txt_marca_vehiculo.Text, txt_nplaca_vehiculo.Text, _Inicio.lblUsuario.Text, Val(TxtViajes.Text), TxtViajesRecomendados.Text)
                            ElseIf lbl_empresa.Text = "DIMOSA" Then
                                fallo = remisiones.NUEVASOLICITUDPRODDIMOSA(dt, dt2, otro_transportista, otro_vehiculo, _txt_otro_transportista.Text, _
                                                        txt_rtn_otro_transportista.Text, txt_marca_vehiculo.Text, txt_nplaca_vehiculo.Text, _Inicio.lblUsuario.Text, Val(TxtViajes.Text), TxtViajesRecomendados.Text)
                            ElseIf lbl_empresa.Text = "SR AGRO" Then
                                fallo = remisiones.NUEVASOLICITUDAGRO(dt, dt2, otro_transportista, otro_vehiculo, txt_otro_transportista.Text, _
                                                        txt_rtn_otro_transportista.Text, txt_nplaca_vehiculo.Text, txt_nplaca_vehiculo.Text, _Inicio.lblUsuario.Text, Val(TxtViajes.Text), TxtViajesRecomendados.Text)
                            ElseIf lbl_empresa.Text = "FLOTA" Then
                                fallo = remisiones.NUEVASOLICITUDFLOTA(dt, dt2, otro_transportista, otro_vehiculo, txt_otro_transportista.Text, _
                                                        txt_rtn_otro_transportista.Text, txt_nplaca_vehiculo.Text, txt_nplaca_vehiculo.Text, _Inicio.lblUsuario.Text, Val(TxtViajes.Text), TxtViajesRecomendados.Text)
                            End If
                        End If
                        ...
                        If fallo = "correcto" Then
                            ...
                            End If
                            If lbl_empresa.Text = "CONSUMO" Or lbl_empresa.Text = "DIMOSA" Or lbl_empresa.Text = "FLOTA" Then
    ...
    Sub validar_inventarios()
        ...
        For i As Integer = 0 To dgv_detalles.RowCount - 1
            ...
            If dgv_detalles.Rows(i).Cells(2).Value <> "" Then
                ...
                If lbl_empresa.Text = "CONSUMO" Or lbl_empresa.Text = "SAN RAFAEL" Then
                    If dgv_detalles.Rows(i).Cells(6).Value = "S" Then
                        ...
                        Try
                            existencia2 = productos.ValidarExistencia_consumo_inventario(Val(lbl_almacen.Text), dgv_detalles.Rows(i).Cells(2).Value)
                        Catch ex As Exception
                        End Try
                        Tipo = "Lote"
                    Else
                    ...
                    End If
                    If Tipo = "Lote" Then
                        If cantidad_remision > existencia2 Then
                            incumplimiento(i) = dgv_detalles.Rows(i).Cells(3).Value
                        End If
                    End If
                ElseIf lbl_empresa.Text = "SR AGRO" Then
                    ...
                    If dgv_detalles.Rows(i).Cells(6).Value = "S" Then
                        ...
                        Try
                            existencia2 = productos.ValidarExistencia_inventarios_sragro(Val(lbl_almacen.Text), dgv_detalles.Rows(i).Cells(2).Value)
                        Catch ex As Exception
                        End Try
                        Tipo = "Lote"
                    Else
                ...
                ElseIf lbl_empresa.Text = "DIMOSA" Then
                    If dgv_detalles.Rows(i).Cells(6).Value = "S" Then
                        existencia = productos.ValidarExistencia_dimosa(Val(lbl_almacen.Text), dgv_detalles.Rows(i).Cells(2).Value)
                        Try
                            existencia2 = productos.ValidarExistencia_consumo_inventario_dimosa(Val(lbl_almacen.Text), dgv_detalles.Rows(i).Cells(2).Value)
                        Catch ex As Exception
                        End Try
                        Tipo = "Lote"
                    Else
                        existencia = productos.ValidarExistencia_consumo_inventario_dimosa(Val(lbl_almacen.Text), dgv_detalles.Rows(i).Cells(2).Value)
                        Tipo = "Sin Lote"
                    End If
                ...
                ElseIf lbl_empresa.Text = "FLOTA" Then
                    If dgv_detalles.Rows(i).Cells(6).Value = "S" Then
                        existencia = productos.ValidarExistencia_flota(Val(lbl_almacen.Text), dgv_detalles.Rows(i).Cells(2).Value)
                        Try
                            existencia2 = productos.ValidarExistencia_consumo_inventario_dimosa(Val(lbl_almacen.Text), dgv_detalles.Rows(i).Cells(2).Value)
                        Catch ex As Exception
                        End Try
                        Tipo = "Lote"
                    Else
                        existencia = productos.ValidarExistencia_consumo_inventario_flota(Val(lbl_almacen.Text), dgv_detalles.Rows(i).Cells(2).Value)
                        Tipo = "Sin Lote"
                    End If
        ...
        For i As Integer = 0 To dgv_detalles.RowCount - 1
            If dgv_detalles.Rows(i).Cells(2).Value <> "" Then
                ...
                ElseIf lbl_empresa.Text = "SR AGRO" Then
                    ...
                    End If
                ElseIf lbl_empresa.Text = "DIMOSA" Then
                    If productos.ValidarSIexiste_prod_CONSUMO_dimosa(Val(lbl_almacen_destino.Text), dgv_detalles.Rows(i).Cells(2).Value) = True Then
                    Else
                        validador2 += 1
                        no_existen(i) = dgv_detalles.Rows(i).Cells(3).Value
                    End If
                ElseIf lbl_empresa.Text = "FLOTA" Then
                    If productos.ValidarSIexiste_prod_CONSUMO_FLOTA(Val(lbl_almacen_destino.Text), dgv_detalles.Rows(i).Cells(2).Value) = True Then
                    Else
                        validador2 += 1
                        no_existen(i) = dgv_detalles.Rows(i).Cells(3).Value
                    End If
    ...
    Sub ImprimirRemision_DISAR()
        ...
        Using stream As New FileStream(direccion_archivo & "GuiaRemision " + documento + ".pdf", FileMode.Create)
            ...
            If lbl_empresa.Text = "DIMOSA" Then
    ...
    Sub ImprimirRemision_DIMOSA()
        ...
        Using stream As New FileStream(direccion_archivo & "GuiaRemision " + documento + ".pdf", FileMode.Create)
            ...
            logo = Image.GetInstance(recurso & "\Resources\DIMOSA-26.png")
            tabla_encabezado.AddCell(logo)
            Dim cell As New PdfPCell(New Phrase("DISTRIBUIDORA MODERNA S.A. de C. V. " & vbCrLf & _
                            "Bº Guadalupe, Contiguo a Hilos y Mechas  " & vbCrLf & _
                            "RTN 05019018030031	" & vbCrLf & _
                            "www.sanrafaelhn.com " & vbCrLf & _
                            "Tel. 2509-0007", FontFactory.GetFont("arial", 20, Font.Bold, Color.BLACK)))
