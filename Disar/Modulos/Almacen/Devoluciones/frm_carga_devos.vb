...
Public Class frm_carga_devos
    ...
    Sub cargar_entregador()
        ...
        Try
            ComboEntregador.DataSource = db.Entregadores(cmb_sucursal.SelectedValue, "SAN RAFAEL")
    ...
    Sub cargar()
        Try
            grd_devos.DataSource = conexion.cargar_devos_entrega(cmb_fecha_ini.Value, "ENCABEZADO", ComboEntregador.SelectedValue, "SAN RAFAEL", "")
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
    End Sub
        ...
        Try
            ...
            Else
                ...
                For index As Integer = 0 To grd_devos.Rows.Count - 1
                    ...
                    dt_partidas = conexion.cargar_devos_entrega(cmb_fecha_ini.Value, "PARTIDAS", ComboEntregador.SelectedValue, "SAN RAFAEL", grd_devos.Rows(index).Cells(4).Value)

                    Dim variable_error As String = ""
                    variable_error = conexion.guardar_datos_local_aplicacion_android(dt_encabezado, dt_partidas, "SAN RAFAEL")
