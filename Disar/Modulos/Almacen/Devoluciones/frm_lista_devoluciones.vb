...
Public Class frm_lista_devoluciones
    ...
    Private Sub btn_modificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_modificar.Click
        ...
        frm_nueva_devolucion.Close()
        frm_nueva_devolucion.modo = "visualice"
        frm_nueva_devolucion.num_reg = grd_lista_devoluciones.CurrentRow.Cells(0).Value
        frm_nueva_devolucion.txt_codigo_cliente.Text = grd_lista_devoluciones.CurrentRow.Cells(3).Value
        frm_nueva_devolucion.txt_nombre_cliente.Text = grd_lista_devoluciones.CurrentRow.Cells(4).Value
        frm_nueva_devolucion.txt_tipo.Text = grd_lista_devoluciones.CurrentRow.Cells(5).Value
        frm_nueva_devolucion.txt_codigo_vendedor.Text = grd_lista_devoluciones.CurrentRow.Cells(6).Value
        frm_nueva_devolucion.txt_numero_factura.Text = grd_lista_devoluciones.CurrentRow.Cells(1).Value
        frm_nueva_devolucion.cmb_concepto.SelectedValue = grd_lista_devoluciones.CurrentRow.Cells(10).Value
        frm_nueva_devolucion.txt_codigo_entregador.Text = grd_lista_devoluciones.CurrentRow.Cells(11).Value
        frm_nueva_devolucion.txt_entregador.Text = grd_lista_devoluciones.CurrentRow.Cells(12).Value
        frm_nueva_devolucion.txt_vehiculo.Text = grd_lista_devoluciones.CurrentRow.Cells(13).Value

        frm_nueva_devolucion.grp_ingreso_datos.Enabled = False
        frm_nueva_devolucion.ShowDialog()
    End Sub
    ...
    Private Sub mnu_carga_entregadores_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnu_carga_entregadores.Click
        frm_carga_devos.Close()
        frm_carga_devos.ShowDialog()
    End Sub
