Imports Disar.data
Public Class frm_nueva_devolucion
    ...
    Sub cargar_factura()
        Try
            frm_facturas.Close()
            frm_facturas.con_credito = "devolucion"
            frm_facturas.ShowDialog()
            frm_facturas.txt_numero_factura.Focus()
            If frm_facturas.DialogResult = DialogResult.OK Then
                txt_numero_factura.Text = frm_facturas.factura
                txt_tipo.Text = frm_facturas.tipo
                cmb_fecha_documento.Value = frm_facturas.fecha
                cmb_fecha_entrega.Value = frm_facturas.fecha_entrega
                ...
                cmb_sucursal.SelectedValue = frm_facturas.almacen
                txt_codigo_entregador.Text = frm_facturas.cod_entregador
                txt_entregador.Text = frm_facturas.entregador
                txt_vehiculo.Text = frm_facturas.vehiculo
                txt_codigo_cliente.Text = frm_facturas.cod_cliente
                txt_nombre_cliente.Text = frm_facturas.cliente
                txt_codigo_vendedor.Text = frm_facturas.cod_vendedor
                txt_nombre_vendedor.Text = frm_facturas.vendedor
                cmb_fecha_vencimiento.Value = frm_facturas.fecha_ven
                txt_condicion.Text = frm_facturas.condicion
                txt_rfc.Text = frm_facturas.rfc
                txt_autoriza.Text = frm_facturas.autoriza
                txt_folio.Text = frm_facturas.folio
                txt_autoanio.Text = frm_facturas.autoanio
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
