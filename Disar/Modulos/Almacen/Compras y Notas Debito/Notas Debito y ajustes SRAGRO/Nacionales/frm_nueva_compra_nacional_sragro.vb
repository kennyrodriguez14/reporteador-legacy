Imports Disar.data
Public Class frm_nueva_compra_nacional_sragro
    ...
    Private Sub frm_nueva_compra_nacional_sragro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Else
                ...
                Else
                    ...
                    descuento_mostrador = ((Val(txt_factor_conversion.Text) * Val(txt_precio_final.Text) * Val(txt_cantidad.Text)) / _
                                           (1 - Val(txt_descuento_por.Text) / 100)) - ((Val(txt_factor_conversion.Text) * Val(txt_precio_final.Text) * _
                                            Val(txt_cantidad.Text)))
        ...
        If Val(txt_cantidad.Text) > 0 Then
            ...
            If frm_calculadora_totales_sragro.ShowDialog() = Windows.Forms.DialogResult.OK Then
                If cmb_valores_base.SelectedItem = "Sub Total" Then
                    ...
                    If cmb_uni.SelectedItem = "cj" Then
                        precio = Math.Round(Val(frm_calculadora_totales_sragro.txt_totales.Text) / Val(txt_cantidad.Text) / _
                                            Val(txt_factor_conversion.Text), 6)
                    ElseIf cmb_uni.SelectedItem = "pz" Then
            ...
            End If
        Else
            MessageBox.Show("debe ingresar una cantidad valida", "Cantidad", MessageBoxButtons.OK, MessageBoxIcon.Warning, _
    ...
    Sub ValidaEnvio()
        ...
        Dim ASD As String = "<h4>Los siguientes productos presentan diferencias de precios en compra SR AGRO a " & txt_nombre_proveedor.Text & ":</h4></hr></hr>"
