...
Public Class frm_nd_compras_nacionales_sragro

    Dim conexion As New cls_notas_debito_SRAGRO
    Dim style As Microsoft.Office.Interop.Excel.Style

    Private Sub frm_nd_compras_nacionales_sragro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar()
    End Sub
    ...
    Private Sub btn_nuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_nuevo.Click
        frm_nueva_compra_nacional_sragro.Close()
        frm_nueva_compra_nacional_sragro.modo = "nuevo"
        frm_nueva_compra_nacional_sragro.ShowDialog()
        cargar()
    End Sub
    ...
    Private Sub grd_lista_remisiones_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles grd_lista_remisiones.DoubleClick
        frm_nueva_compra_nacional_sragro.Close()
        frm_nueva_compra_nacional_sragro.modo = "vista"
        vista_datos()
    End Sub

    Sub vista_datos()
        Try
            frm_nueva_compra_nacional_sragro.get_almacen()
            frm_nueva_compra_nacional_sragro.codigo_compra = grd_lista_remisiones.CurrentRow.Cells(0).Value
            frm_nueva_compra_nacional_sragro.txt_codigo_proveedor.Text = grd_lista_remisiones.CurrentRow.Cells(1).Value
            frm_nueva_compra_nacional_sragro.txt_nombre_proveedor.Text = grd_lista_remisiones.CurrentRow.Cells(2).Value
            frm_nueva_compra_nacional_sragro.cmb_sucursal.SelectedValue = grd_lista_remisiones.CurrentRow.Cells(3).Value
            frm_nueva_compra_nacional_sragro.txt_referencia_proveedor.Text = grd_lista_remisiones.CurrentRow.Cells(4).Value
            frm_nueva_compra_nacional_sragro.txt_rfc.Text = grd_lista_remisiones.CurrentRow.Cells(5).Value
            frm_nueva_compra_nacional_sragro.cmb_fecha_documento.Value = grd_lista_remisiones.CurrentRow.Cells(6).Value
            frm_nueva_compra_nacional_sragro.txt_descuento_general.Text = grd_lista_remisiones.CurrentRow.Cells(7).Value
            frm_nueva_compra_nacional_sragro.txt_subtotal_final.Text = grd_lista_remisiones.CurrentRow.Cells(8).Value
            frm_nueva_compra_nacional_sragro.txt_descuento_final.Text = grd_lista_remisiones.CurrentRow.Cells(9).Value
            frm_nueva_compra_nacional_sragro.txt_isv_final.Text = grd_lista_remisiones.CurrentRow.Cells(10).Value
            frm_nueva_compra_nacional_sragro.txt_total_final.Text = grd_lista_remisiones.CurrentRow.Cells(11).Value
            frm_nueva_compra_nacional_sragro.txt_subtotalmostrador.Text = grd_lista_remisiones.CurrentRow.Cells(14).Value
            frm_nueva_compra_nacional_sragro.txt_descuento_mostrador.Text = grd_lista_remisiones.CurrentRow.Cells(15).Value
            frm_nueva_compra_nacional_sragro.txt_isvmostrador.Text = grd_lista_remisiones.CurrentRow.Cells(16).Value
            frm_nueva_compra_nacional_sragro.txt_totalmostrador.Text = grd_lista_remisiones.CurrentRow.Cells(17).Value
    ...
    Private Sub btn_modificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_modificar.Click
        Try
            ...
            Else
                frm_nueva_compra_nacional_sragro.Close()
                frm_nueva_compra_nacional_sragro.modo = "modificar"
                vista_datos()
                cargar()
            End If
        Catch ex As Exception
    ...
    Private Sub BtnExportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnExportar.Click
        ...
        wSheet.Cells.Range("A1:I1").Value = " Reporte de Compras Nacionales SR AGRO "
