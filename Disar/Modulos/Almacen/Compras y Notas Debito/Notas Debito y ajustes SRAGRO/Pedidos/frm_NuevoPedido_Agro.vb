...
Public Class frm_NuevoPedido_Agro
    ...
    Private Sub Agregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Agregar.Click
        Try
            If IsNumeric(TextCantidad.Text) And TextCantidad.Text <> "" And TextProducto.Text <> "" Then
                ...
                dt = db.CargaCodigoProveedorAgro(TextProducto.Text)
    ...
    Private Sub btn_aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_aceptar.Click
        ...
        If DataDatos.Rows.Count > 0 Then
            ...
            Try
                ...
                Contenido &= "<h4> Buen día. Se adjuntan las siguientes órdenes para ser entregadas en las diferentes sucursales, su apoyo con la entrega en los días correspondientes </h4>"
                ExportarPDF()
                ...
                dtPrincipal = db.CargaCorreos(ComboProv.SelectedValue, "O", "SR AGRO")
                dtCopias = db.CargaCorreos(ComboProv.SelectedValue, "C", "SR AGRO")
                ...
                For a As Integer = 1 To 13

                    If a = 1 Then
                        Contenido &= "<h4> ALMACEN AGRO SRC </h4>"
                    ElseIf a = 2 Then
                        Contenido &= "<h4> ALMACEN AGRO GRACIAS </h4>"
                    ElseIf a = 3 Then
                        Contenido &= "<h4> ALMACEN AGRO </h4>"
                    ElseIf a = 9 Or a = 13 Then
                        Contenido &= "<h4> ALMACEN AGRO TEGUCIGALPA </h4>"
                    End If
                    ...
                    If dt.Rows.Count > 0 Then
                        Dim s = db.NuevoRegistro(ComboProv.SelectedValue, ComboProv.Text, _Inicio.lblUsuario.Text, dt, ComboBox1.Text, "SR AGRO")
    ...
    Sub ImprimirRemision_DISAR(ByVal Numero As Integer, ByVal dt As DataTable, ByVal Almacen As Integer)
        ...
        Using stream As New FileStream(direccion_archivo & "Pedido " & ComboProv.Text & " Numero " & Numero & ".pdf", FileMode.Create)
            ...
            tabla_encabezado.AddCell("" & vbNewLine & vbNewLine)
            tabla_encabezado.AddCell("" & vbNewLine & vbNewLine)
            Dim cell As New PdfPCell(New Phrase("SAN RAFAEL AGROSERVICIOS S.A. DE C.V. " & vbCrLf & _
    ...
    Public Function ImportExcellToDataGridView(ByRef path As String, ByVal Datagrid As DataGridView)
        ...
        Catch ex As Exception
            MsgBox("El nombre de la hoja de carga debe ser Hoja1 " & ex.Message, MsgBoxStyle.Critical, "Error")
        End Try
        Return True
    End Function
