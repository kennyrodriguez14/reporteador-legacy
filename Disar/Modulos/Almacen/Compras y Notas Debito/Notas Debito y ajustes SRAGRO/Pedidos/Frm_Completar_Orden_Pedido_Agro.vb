...
Public Class Frm_Completar_Orden_Pedido_Agro
    ...
    Sub ImprimirRemision_DISAR(ByVal Numero As Integer, ByVal dt As DataTable, ByVal Almacen As Integer)
        ...
        tabla_sub_encabezado.SetWidths(New Integer() {1, 8, 4})
        ...
        If Almacen = 1 Then
            Sucursal = "ALMACEN AGRO-SRC"
        ElseIf Almacen = 3 Then
            Sucursal = "ALMACEN AGRO"
        ElseIf Almacen = 9 Or Almacen = 13 Then
            Sucursal = "ALMACEN AGRO SPS"
        End If
        ...
        Using stream As New FileStream(direccion_archivo & "Recepcion " & TextProveedor.Text & " Numero " & Numero & ".pdf", FileMode.Create)
            ...
            tabla_sub_encabezado.AddCell("Recibido por: ____________________" & vbNewLine & "Firma: ______________________")
