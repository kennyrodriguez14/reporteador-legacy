...
Public Class FormCargaTodasPartidasCompraNacionalAgro
    ...
    Private Sub TextBuscar_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextBuscar.KeyDown
        If e.KeyCode = Keys.Enter Then
            For Each row As DataGridViewRow In DataDatos.Rows
                If CStr(row.Cells(2).Value).ToUpper = TextBuscar.Text Or CStr(row.Cells(3).Value).ToUpper = TextBuscar.Text Then
                    row.Selected = True
                    Exit For
                End If
            Next
    ...
    Private Sub DataDatos_CellClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataDatos.CellClick
        If e.ColumnIndex = 6 Then
            If Val(DataDatos.CurrentRow.Cells(0).Value) > 0 Then
                ...
                If frm_calculadora_totales.ShowDialog() = Windows.Forms.DialogResult.OK Then
                    ...
                    If frm_nueva_compra_nacional_sragro.cmb_valores_base.SelectedItem = "Sub Total" Then
                    ...
                    ElseIf frm_nueva_compra_nacional_sragro.cmb_valores_base.SelectedItem = "Impuesto" Then
        ...
        If e.ColumnIndex = 12 Then
            ...
            Try
                ...
                Else
                    If Val(DataDatos.CurrentRow.Cells(0).Value) > DataDatos.CurrentRow.Cells(13).Value Then
                    ...
                    frm_nueva_compra_nacional_sragro.grd_ingreso.Rows.Add(Val(DataDatos.CurrentRow.Cells(0).Value), DataDatos.CurrentRow.Cells(2).Value, DataDatos.CurrentRow.Cells(3).Value, DataDatos.CurrentRow.Cells(4).Value, _
                    ...
                    frm_nueva_compra_nacional_sragro.limpiar()
                    frm_nueva_compra_nacional_sragro.sumar_totales()

                    frm_nueva_compra_nacional_sragro.grd_ingreso.ClearSelection()
                    frm_nueva_compra_nacional_sragro.grd_ingreso.Rows(frm_nueva_compra_nacional_sragro.grd_ingreso.RowCount - 1).Selected = True
                    frm_nueva_compra_nacional_sragro.grd_ingreso.Refresh()
                    frm_nueva_compra_nacional_sragro.cmb_sucursal.Enabled = False
