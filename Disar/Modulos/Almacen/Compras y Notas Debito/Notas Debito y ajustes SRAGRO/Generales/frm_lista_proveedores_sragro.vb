Imports Disar.data
Public Class frm_lista_proveedores_sragro
    Dim conexion As New cls_notas_debito_SRAGRO
    Public codigo, nombre, rfc As String
    Public dias_aut As Integer
    Public cargill As String
    Private Sub frm_lista_proveedores_sragro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        grd_lista.Focus()
        If cargill = "S" Then
            cargar_cargill()
        Else
    ...
    Sub cargar()
        Try
            grd_lista.DataSource = conexion.mostrar_proveedores(txt_busqueda.Text)
    ...
    Private Sub grd_lista_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles grd_lista.DoubleClick
        Try
            ...
            dias_aut = grd_lista.CurrentRow.Cells(3).Value
