Imports Disar.data
Public Class frm_productos_precios_neg_sragro
    ...
    Private Sub frm_productos_precios_neg_sragro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar()
    End Sub
    ...
    Sub cargar()
        Try
            grd_lista.DataSource = conexion.listar_productos(txt_busqueda.Text, proveedor)
    ...
    Sub aceptar_producto()
        ...
        dt = conexion.valida_productos(grd_lista.CurrentRow.Cells(0).Value, almacen)
