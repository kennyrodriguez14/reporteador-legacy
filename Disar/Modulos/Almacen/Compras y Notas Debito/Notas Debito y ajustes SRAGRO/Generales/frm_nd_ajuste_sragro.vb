Imports Disar.data
Public Class frm_nd_ajuste_sragro
    Dim conexion As New cls_notas_debito_SRAGRO
    Public COMPRA As String
    Public tasa As Double
    Public tipo As String
    Private Sub frm_nd_ajuste_sragro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar()
    End Sub
    ...
    Sub cargar()
        Try
            ...
            dt = conexion.listar_ajuste(COMPRA, "DEBITO")
