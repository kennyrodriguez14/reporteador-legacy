Imports Disar.data
Public Class frm_nd_ajuste_opl
    ...
    Sub cargar()
        Try
            ...
            dt = conexion.listar_ajuste_opl(COMPRA, "DEBITO")
            ...
            grd_lista.DataSource = conexion.listar_ajuste_partidas_opl(dt.Rows(0)(0))
    ...
    Sub Exportar()
        Try
            ...
            wSheet.Cells.Range("A3:C3").Value = "OPL HONDURAS"
