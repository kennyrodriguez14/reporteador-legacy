...
Public Class frm_productos_precios_neg_opl
    ...
    Sub cargar()
        Try
            grd_lista.DataSource = conexion.listar_productos_opl(txt_busqueda.Text, proveedor)
    ...
    Sub aceptar_producto()
        ...
        dt = conexion.valida_productos_opl(grd_lista.CurrentRow.Cells(0).Value, almacen)
