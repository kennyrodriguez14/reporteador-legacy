Imports Disar.data
Public Class frm_orden_pedidos
        ...
        Try
            If grd_ingreso.RowCount > 0 Or txt_num_registro.Text = "" Or txt_codigo_proveedor.Text = "" Then
                ...
                If modo = "upd" Then
                    ...
                    correcto = conexion.update_orden_pedido(txt_num_registro.Text, cmb_fecha_documento.Value, Convert.ToDouble(txt_subtotal_final.Text), Convert.ToDouble(txt_descuento_final.Text), _
    ...
    Private Sub btn_get_folio_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_get_folio.Click
        frm_nd_folios.Close()
        If frm_nd_folios.ShowDialog = Windows.Forms.DialogResult.OK Then
            txt_num_registro.Text = frm_nd_folios.folio & frm_nd_folios.ult_doc
            cmb_sucursal.SelectedValue = frm_nd_folios.almacen
            folio = frm_nd_folios.folio
            ult_docto = frm_nd_folios.ult_doc
        End If
    End Sub
End Class