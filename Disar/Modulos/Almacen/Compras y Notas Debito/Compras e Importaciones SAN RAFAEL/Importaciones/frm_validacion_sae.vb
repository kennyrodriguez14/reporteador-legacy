Imports Disar.data
Public Class frm_validacion_sae
    ...
    Private Sub frm_validacion_sae_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            grd_repo.DataSource = conexion_notas_debito.validacion_sae_reporteador(CLAVE, "REPO")
            grd_sae.DataSource = conexion_notas_debito.validacion_sae_reporteador(CLAVE, "SAE")
