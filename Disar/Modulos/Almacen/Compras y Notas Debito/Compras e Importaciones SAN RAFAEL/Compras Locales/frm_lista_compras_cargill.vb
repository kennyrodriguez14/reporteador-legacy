...
Public Class frm_lista_compras_cargill
    ...
    Private Sub btn_nuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_nuevo.Click
        frm_nd_compras_cargill.Close()
        frm_nd_compras_cargill.modo = "nuevo"
        frm_nd_compras_cargill.ShowDialog()
        cargar()
    End Sub
    ...
    Private Sub grd_lista_remisiones_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles grd_lista_remisiones.DoubleClick
        frm_nd_compras_cargill.Close()
        frm_nd_compras_cargill.modo = "vista"
        vista_datos()
    End Sub

    Sub vista_datos()
        Try
            frm_nd_compras_cargill.get_almacen()
            frm_nd_compras_cargill.codigo_compra = grd_lista_remisiones.CurrentRow.Cells(0).Value
            frm_nd_compras_cargill.txt_codigo_proveedor.Text = grd_lista_remisiones.CurrentRow.Cells(1).Value
            frm_nd_compras_cargill.txt_nombre_proveedor.Text = grd_lista_remisiones.CurrentRow.Cells(2).Value
            frm_nd_compras_cargill.cmb_sucursal.SelectedValue = grd_lista_remisiones.CurrentRow.Cells(3).Value
            frm_nd_compras_cargill.txt_referencia_proveedor.Text = grd_lista_remisiones.CurrentRow.Cells(4).Value
            frm_nd_compras_cargill.txt_rfc.Text = grd_lista_remisiones.CurrentRow.Cells(5).Value
            frm_nd_compras_cargill.cmb_fecha_documento.Value = grd_lista_remisiones.CurrentRow.Cells(6).Value
            frm_nd_compras_cargill.txt_descuento_general.Text = grd_lista_remisiones.CurrentRow.Cells(7).Value
            frm_nd_compras_cargill.txt_subtotal_final.Text = grd_lista_remisiones.CurrentRow.Cells(8).Value
            frm_nd_compras_cargill.txt_descuento_final.Text = grd_lista_remisiones.CurrentRow.Cells(9).Value
            frm_nd_compras_cargill.txt_isv_final.Text = grd_lista_remisiones.CurrentRow.Cells(10).Value
            frm_nd_compras_cargill.txt_total_final.Text = grd_lista_remisiones.CurrentRow.Cells(11).Value
            frm_nd_compras_cargill.txt_subtotalmostrador.Text = grd_lista_remisiones.CurrentRow.Cells(14).Value
            frm_nd_compras_cargill.txt_descuento_mostrador.Text = grd_lista_remisiones.CurrentRow.Cells(15).Value
            frm_nd_compras_cargill.txt_isvmostrador.Text = grd_lista_remisiones.CurrentRow.Cells(16).Value
            frm_nd_compras_cargill.txt_totalmostrador.Text = grd_lista_remisiones.CurrentRow.Cells(17).Value
            frm_nd_compras_cargill.txt_flete.Text = grd_lista_remisiones.CurrentRow.Cells(18).Value

            frm_nd_compras_cargill.txt_isv_flete.Text = grd_lista_remisiones.CurrentRow.Cells(19).Value
            frm_nd_compras_cargill.txt_total_flete.Text = grd_lista_remisiones.CurrentRow.Cells(20).Value
    ...
    Private Sub btn_modificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_modificar.Click
        Try
            ...
            Else
                frm_nd_compras_cargill.Close()
                frm_nd_compras_cargill.modo = "modificar"
                vista_datos()
                cargar()
            End If
        Catch ex As Exception
    ...
    Private Sub frm_lista_compras_cargill_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar()
    End Sub
    ...
    Private Sub BtnExportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnExportar.Click
        ...
        wSheet.Cells.Range("A1:J1").Value = " Reporte de Compras Cargill "
