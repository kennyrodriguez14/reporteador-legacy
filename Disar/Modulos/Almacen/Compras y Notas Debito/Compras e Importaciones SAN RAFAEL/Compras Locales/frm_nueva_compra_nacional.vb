...
Public Class frm_orden_compra_nacional
                ...
                Else
                    ...
                    If modo = "nuevo" Then
                        If MessageBox.Show("¿Desea enviar la compra a SAE?", "Confirmacion", MessageBoxButtons.YesNoCancel, _
                            ...
                            resultado = conexion.guardar_compras_local_envio_SAE(dt_e, dt_p, conlote, lote, cmb_fecha_vencimiento.Value, _Inicio.lblUsuario.Text, TextPedido.Text)
                        Else
                            resultado = conexion.guardar_compras_local(dt_e, dt_p, lote, cmb_fecha_vencimiento.Value, TextPedido.Text)
                        End If

                    ElseIf modo = "modificar" Then
                        resultado = conexion.modificar_compras_local(dt_e, dt_p, codigo_compra, lote, cmb_fecha_vencimiento.Value)
    ...
    Private Sub VerNotas_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles VerNotas.Click
        ...
        For i As Integer = 0 To grd_ingreso.RowCount - 1
            ...
            Try
                ...
                dta = db.listar_productos(grd_ingreso.Rows(i).Cells(1).Value, txt_codigo_proveedor.Text)
                PrecioNeg = dta(0)(3)
            Catch ex As Exception
    ...
    Sub ValidaEnvio()
        ...
        Dim ASD As String = "<h4>Los siguientes productos presentan diferencias de precios en compra SAN RAFAEL a " & txt_nombre_proveedor.Text & ":</h4></hr></hr>"
