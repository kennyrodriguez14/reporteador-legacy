...
Public Class frm_lista_compras_dev_dimosa
        ...
        Try
            If e.KeyValue = Keys.Enter Then
                If tipo_compra = "imp" Then
                    grd_lista.DataSource = conexion.lista_importaciones_devolver_DIMOSA(txt_busqueda.Text, cmb_tipo.SelectedItem)
                    ...
                    End If
                Else
                    grd_lista.DataSource = conexion.lista_Compras_devolver_DIMOSA(txt_busqueda.Text, cmb_tipo.SelectedItem)
