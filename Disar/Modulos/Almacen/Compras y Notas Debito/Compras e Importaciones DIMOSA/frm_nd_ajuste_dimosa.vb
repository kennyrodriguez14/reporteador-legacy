Imports Disar.data
Public Class frm_nd_ajuste_dimosa
    Dim conexion As New cls_notas_debito
    Public COMPRA As String
    Public tasa As Double
    Public tipo As String
    Private Sub frm_nd_ajuste_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar()
    End Sub
    ...
    Sub cargar()
        Try
            ...
            dt = conexion.listar_ajuste_DIMOSA(COMPRA, "DEBITO")
            ...
            grd_lista.DataSource = conexion.listar_ajuste_partidas_DIMOSA(dt.Rows(0)(0))
    ...
    Sub Exportar()
        Try
            ...
            wSheet.Cells.Range("A2:C2").Value = "NOTA DE DEBITO"
            wSheet.Cells.Range("A2:C2").Font.Size = 16
            wSheet.Cells.Range("A2:C2").Font.Bold = True

            wSheet.Cells.Range("A3:C3").Merge()
            wSheet.Cells.Range("A3:C3").Value = "DISTRIBUIDORA MODERNA S.A. DE C.V."
            ...
            wSheet.Cells.Range("A7:I7").Value = "ESTIMADO PROVEEDOR, A CONTINUACION ESPECIFICAMOS EL MOTIVO Y MONTO POR LA CUAL SE ELABORA LA PRESENTE NOTA DE DEBITO:"
