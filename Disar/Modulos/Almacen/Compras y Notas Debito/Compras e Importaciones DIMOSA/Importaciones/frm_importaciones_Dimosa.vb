Imports Disar.data
Public Class frm_importaciones_dimosa
    ...
    Private Sub btn_new_prov_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_new_prov.Click
        frm_lista_proveedores_dimosa.Close()
    ...
    Sub cargar_otros_prov(ByVal buscar As String)
        cmb_otro_proveedores.DataSource = conexion_otro_prov.mostrar_proveedores_DIMOSA(buscar)
    ...
    Sub tasa_cambio()
        Try
            ...
            dt = conexion.listar_tasa_cambio_DIMOSA
                ...
                If grd_ingreso.Rows.Count > 0 Then
                    ...
                    If modo = "nuevo" Then
                        If MessageBox.Show("¿Desea enviar la compra a SAE?", "Confirmacion", MessageBoxButtons.YesNoCancel, _
                            ...
                            resultado = conexion.guardar_importacion_local_SAE_DIMOSA(dt_e, dt_p, conlote, lote, cmb_fecha_vencimiento.Value.Date, _
                                                _Inicio.lblUsuario.Text, txt_cliente_rastra.Text, txt_nombre_rastra.Text)
                        Else
                            resultado = conexion.guardar_importacion_local_DIMOSA(dt_e, dt_p, lote, cmb_fecha_vencimiento.Value.Date, _
                                                                           _Inicio.lblUsuario.Text, txt_cliente_rastra.Text, txt_nombre_rastra.Text)
                        End If
                    ElseIf modo = "modificar" Then
                        resultado = conexion.modificar_importacion_local_DIMOSA(dt_e, dt_p, codigo_compra, lote, cmb_fecha_vencimiento.Value.Date, _
                        ...
                        If resultado = "correcto" Then
                            If MessageBox.Show("¿Desea enviar la compra a SAE?", "Confirmacion", MessageBoxButtons.YesNo, _
                                               MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                                resultado = conexion.envio_individual_importacion_local_DIMOSA(dt_e, dt_p, codigo_compra, _
    ...
    Sub envio_coi(ByVal inventario As Double, ByVal isv As Double, ByVal cxp_sae As Double, ByVal acreedores_serv As Double, ByVal isv_haber As Double, _
        ...
        resultado_coi = envio_coi.enviar_coi_dimosa(dt_contabilizacion, cmb_fecha_documento.Value.Year, cmb_fecha_documento.Value.Month, _
                                             cmb_fecha_documento.Value, "Co", cmb_fecha_documento.Value, cmb_fecha_documento.Value, _
                                             "Compra: " + cve_doc + " ", "09", txt_nombre_proveedor.Text, cve_reporteador)
        Dim resultado_coi2 As String
        resultado_coi2 = envio_coi.enviar_coi_dimosa(dt_contabilizacion2, cmb_fecha_documento.Value.Year, cmb_fecha_documento.Value.Month, _
                                             cmb_fecha_documento.Value, "Co", cmb_fecha_documento.Value, cmb_fecha_documento.Value, _
                                              "Boletin: " + txt_numero_boletin.Text + " Compra:" + cve_doc + " ", "09", txt_nombre_proveedor.Text, _
                                                    cve_reporteador)
    ...
    Sub cargar_totales()
        ...
        If frm_calculadora_totales_dimosa.ShowDialog() = Windows.Forms.DialogResult.OK Then
            If cmb_uni.SelectedItem = "cj" Then
                txt_precio_final.Text = Math.Round(Val(frm_calculadora_totales_dimosa.txt_totales.Text) _
                                                   / Val(txt_cantidad.Text) / Val(txt_factor_conversion.Text), 6)
            ElseIf cmb_uni.SelectedItem = "pz" Then
                txt_precio_final.Text = Math.Round(Val(frm_calculadora_totales_dimosa.txt_totales.Text) * Val(txt_cantidad.Text), 6)
            Else
                txt_precio_final.Text = Math.Round(Val(frm_calculadora_totales_dimosa.txt_totales.Text) / _
                                                   Val(txt_cantidad.Text) / Val(txt_factor_conversion.Text), 6)
            End If
    ...
    Sub cargar_partidas()
        Try
            Dim dt As New DataTable
            dt = conexion.listar_partidas_importaciones_DIMOSA(codigo_compra)
    ...
    Private Sub cmb_otro_prov_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmb_otro_prov.CheckedChanged
        ...
        If cmb_otro_prov.Checked = True Then
            ...
            cmb_otro_proveedores.DataSource = conexion_otro_prov.mostrar_proveedores_DIMOSA("")
            cmb_otro_proveedores.ValueMember = "CLAVE"
            cmb_otro_proveedores.DisplayMember = "NOMBRE"
        Else
            cmb_otro_proveedores.Enabled = False
            cmb_otro_proveedores.DataSource = conexion_otro_prov.mostrar_proveedores_DIMOSA("       565")
            cmb_otro_proveedores.ValueMember = "CLAVE"
            cmb_otro_proveedores.DisplayMember = "NOMBRE"
        End If
    ...
    Private Sub btn_rastra_directa_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_rastra_directa.Click
        ...
        If frm_clie_rastra_DIMOSA.ShowDialog() = Windows.Forms.DialogResult.OK Then
            txt_cliente_rastra.Text = frm_clie_rastra_DIMOSA.codigo
            txt_nombre_rastra.Text = frm_clie_rastra_DIMOSA.cliente
        End If
    ...
    Private Sub frm_importaciones_dimosa_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.F4 Then
            frm_totalizador_dimosa.txt_flete.Text = txt_flete.Text
            frm_totalizador_dimosa.txt_seguro.Text = txt_seguro.Text
            frm_totalizador_dimosa.txt_pyc.Text = txt_pyc.Text
            frm_totalizador_dimosa.txt_honorarios.Text = txt_honorarios.Text
            frm_totalizador_dimosa.txt_parqueo_D.Text = txt_parqueo_D.Text
            frm_totalizador_dimosa.txt_rev_des_carg_D.Text = txt_rev_des_carg_D.Text
            frm_totalizador_dimosa.txt_emision_gr_D.Text = txt_emision_gr_D.Text
            frm_totalizador_dimosa.txt_encomiendas_D.Text = txt_encomiendas_D.Text
            frm_totalizador_dimosa.txt_gastos_variables_d.Text = txt_gastos_variables_d.Text
            frm_totalizador_dimosa.txt_servicio_tranporte_datos.Text = txt_servicio_tranporte_datos.Text
            frm_totalizador_dimosa.txt_servicio_portuario.Text = txt_servicio_portuario.Text
            frm_totalizador_dimosa.txt_especies_fiscales.Text = txt_especies_fiscales.Text
            frm_totalizador_dimosa.txt_dai.Text = txt_dai.Text
            frm_totalizador_dimosa.txt_ivz.Text = txt_ivz.Text
            frm_totalizador_dimosa.txt_fob.Text = txt_total_final.Text
            frm_totalizador_dimosa.txt_isv.Text = txt_isv.Text
            frm_totalizador_dimosa.tasa_cambio = txt_tasa_pactada.Text
            frm_totalizador_dimosa.ShowDialog()
        End If
    End Sub

    Private Sub btn_validar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_validar.Click
        frm_validacion_sae_DIMOSA.Close()
        frm_validacion_sae_DIMOSA.CLAVE = txt_id.Text
        frm_validacion_sae_DIMOSA.ShowDialog()
    End Sub
