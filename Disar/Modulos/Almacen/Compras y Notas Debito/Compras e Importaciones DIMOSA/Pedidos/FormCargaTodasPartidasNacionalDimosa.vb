...
Public Class FormCargaTodasPartidasCompraNacionalDimosa
        ...
        If e.ColumnIndex = 6 Then
            If Val(DataDatos.CurrentRow.Cells(0).Value) > 0 Then
                ...
                If frm_calculadora_totales.ShowDialog() = Windows.Forms.DialogResult.OK Then
                    ...
                    If frm_orden_compra_nacional_DIMOSA.cmb_valores_base.SelectedItem = "Sub Total" Then
                    ...
                    ElseIf frm_orden_compra_nacional_DIMOSA.cmb_valores_base.SelectedItem = "Impuesto" Then
        ...
        If e.ColumnIndex = 13 Then
            ...
            Try
                ...
                Else
                    ...
                    frm_orden_compra_nacional_DIMOSA.grd_ingreso.Rows.Add(Val(DataDatos.CurrentRow.Cells(0).Value), DataDatos.CurrentRow.Cells(2).Value, DataDatos.CurrentRow.Cells(3).Value, DataDatos.CurrentRow.Cells(4).Value, _
                    ...
                    frm_orden_compra_nacional_DIMOSA.limpiar()
                    frm_orden_compra_nacional_DIMOSA.sumar_totales()

                    frm_orden_compra_nacional_DIMOSA.grd_ingreso.ClearSelection()
                    frm_orden_compra_nacional_DIMOSA.grd_ingreso.Rows(frm_orden_compra_nacional_DIMOSA.grd_ingreso.RowCount - 1).Selected = True
                    frm_orden_compra_nacional_DIMOSA.grd_ingreso.Refresh()
                    frm_orden_compra_nacional_DIMOSA.cmb_sucursal.Enabled = False
