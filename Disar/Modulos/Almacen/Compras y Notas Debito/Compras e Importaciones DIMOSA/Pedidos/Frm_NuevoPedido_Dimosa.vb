...
Public Class frm_NuevoPedido_Dimosa
    ...
    Private Sub Agregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Agregar.Click
        Try
            If IsNumeric(TextCantidad.Text) And TextCantidad.Text <> "" And TextProducto.Text <> "" Then
                ...
                dt = db.CargaCodigoProveedorDimosa(TextProducto.Text)
    ...
    Private Sub BtnCargaProducto_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCargaProducto.Click
        Frm_Carga_Productos_DIMOSA.PROV = ComboProv.SelectedValue
        If Frm_Carga_Productos_DIMOSA.ShowDialog = Windows.Forms.DialogResult.OK Then
            TextProducto.Text = Frm_Carga_Productos_DIMOSA.CLAVE
            TextNombreProducto.Text = Frm_Carga_Productos_DIMOSA.DESCRIPCION
        End If
    End Sub
    ...
    Private Sub btn_aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_aceptar.Click
        ...
        If DataDatos.Rows.Count > 0 Then
            ...
            Try
                ...
                dtPrincipal = db.CargaCorreos(ComboProv.SelectedValue, "O", "DIMOSA")
                dtCopias = db.CargaCorreos(ComboProv.SelectedValue, "C", "DIMOSA")
                ...
                For a As Integer = 1 To 4
                    ...
                    If dt.Rows.Count > 0 Then
                        Dim s = db.NuevoRegistro(ComboProv.SelectedValue, ComboProv.Text, _Inicio.lblUsuario.Text, dt, ComboBox1.Text, "DIMOSA")
    ...
    Private Sub BtnDestinatarios_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDestinatarios.Click
        Form_DestinatariosProveedores.Empresa = "DIMOSA"
        Form_DestinatariosProveedores.Proveedor = ComboProv.SelectedValue

        Form_DestinatariosProveedores.TextEmpresa.Text = "DIMOSA"
