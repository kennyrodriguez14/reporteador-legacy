Imports Disar.data
Public Class frm_precios_negociados_dimosa
    ...
    Private Sub btn_guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_guardar.Click
        ...
        Try
            If txt_validador.Text = "ins" Then
                ...
                var_error = conexion_notas_debito.insertar_precio_DIMOSA(txt_codigo.Text, Val(txt_precio_negociado.Text), usuario_id, usuario_name, Now, precio_anterior)
            ...
            Else
                Dim var_error As String = ""
                var_error = conexion_notas_debito.actualizar_precio_DIMOSA(txt_codigo.Text, Val(txt_precio_negociado.Text), usuario_id, usuario_name, Now, precio_anterior)
                If var_error = "correcto" Then
                    MessageBox.Show("Precio actualizado")
                Else
                    MessageBox.Show("Error al actualizar precio" + var_error)
    ...
    Sub cargar_proveedores()
        Try
            cmb_proveedor.DataSource = conexion_notas_debito.cargar_proveedores_dimosa()
    ...
    Sub cargar()
        Try
            grd_precios.DataSource = conexion_notas_debito.filtros_DIMOSA(txt_buqueda.Text, cmb_proveedor.SelectedValue)
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
    End Sub
