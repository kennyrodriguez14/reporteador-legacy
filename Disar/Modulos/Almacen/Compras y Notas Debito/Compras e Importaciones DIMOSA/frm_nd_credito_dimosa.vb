Imports Disar.data
Public Class frm_nd_credito_dimosa
    Dim conexion As New cls_notas_debito
    Public COMPRA As String
    Public tipo As String
    Public tasa As Double
    Private Sub frm_nd_credito_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar()
    End Sub
    ...
    Sub cargar()
        Try
            ...
            dt = conexion.listar_ajuste_DIMOSA(COMPRA, "CREDITO")
