...
Public Class frm_fechas_vencimiento
    Dim Clase As New cls_reporte_carga
    Dim conexion As New clsFechas_vencimiento
    Dim style As Microsoft.Office.Interop.Excel.Style
    Private Sub frm_fechas_vencimiento_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cmb_empresa.SelectedItem = "CONSUMO"
        Cargar_Almacen()
    End Sub

    Sub Cargar_Almacen()
        cmbAlmacen.DataSource = Clase.getAlmacen(0, 0, cmb_empresa.SelectedItem, Now, "", "ALM", 1)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_generar.Click
        grdReporte.DataSource = conexion.Reporte_fechas_vencimiento(cmbAlmacen.SelectedValue, cmb_empresa.Text)
    End Sub
    ...
    Sub Exportar()
        Try
            ...
            wSheet.Cells.Range("A1:D1").Value = "Fechas de Vencimiento almacen " + cmbAlmacen.Text
