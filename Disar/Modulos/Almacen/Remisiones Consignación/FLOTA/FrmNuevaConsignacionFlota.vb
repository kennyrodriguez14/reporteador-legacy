...
Public Class FrmNuevaConsignacionFlota

    Dim remisiones As New cls_remisiones
    Dim Consig As New ClsConsignacionesFlota
    ...
    Sub cargar_remitente()
        Try
            cmb_remite.DataSource = remisiones.SucursalesFLOTA
    ...
    Private Sub BtnBuscaCliente_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnBuscaCliente.Click
        If frm_clientes_FLOTA.ShowDialog = Windows.Forms.DialogResult.OK Then
            TextClaveCliente.Text = frm_clientes_FLOTA.codigo
            TextNombreCliente.Text = frm_clientes_FLOTA.cliente
        End If
    End Sub
