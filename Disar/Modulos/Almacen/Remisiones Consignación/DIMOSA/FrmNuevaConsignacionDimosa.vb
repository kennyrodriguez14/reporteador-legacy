...
Public Class FrmNuevaConsignacionDimosa
    ...
    Sub cargar_entradas()
        Try
            ...
            ElseIf lbl_empresa.Text = "DIMOSA" Then
                cmb_concepto_entrada.DataSource = remisiones.conceptos_entradas_DIMOSA()
                cmb_concepto_entrada.DisplayMember = "DESCRIPCION"
                cmb_concepto_entrada.ValueMember = "CONCEPTO"
                cmb_concepto_entrada.SelectedValue = 14
    ...
    Sub cargar_salidas()
        Try
            ...
            ElseIf lbl_empresa.Text = "DIMOSA" Then
                cmb_concepto_salida.DataSource = remisiones.conceptos_salidas_DIMOSA()
                cmb_concepto_salida.DisplayMember = "DESCRIPCION"
                cmb_concepto_salida.ValueMember = "CONCEPTO"
                cmb_concepto_salida.SelectedValue = 67
            ElseIf lbl_empresa.Text = "SR AGRO" Then
                    ...
                    If validador2 = 0 Then
                        If validador = 0 Then
                            ...
                            If lbl_empresa.Text = "DIMOSA" Then
                                fallo = Consig.NUEVASOLICITUDPRODDIMOSA(dt, dt2, otro_transportista, otro_vehiculo, _txt_otro_transportista.Text, _
    ...
    Private Sub BtnBuscaCliente_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnBuscaCliente.Click
        If frm_clientes_dimosa.ShowDialog = Windows.Forms.DialogResult.OK Then
            TextClaveCliente.Text = frm_clientes_dimosa.codigo
            TextNombreCliente.Text = frm_clientes_dimosa.cliente
        End If
    End Sub
