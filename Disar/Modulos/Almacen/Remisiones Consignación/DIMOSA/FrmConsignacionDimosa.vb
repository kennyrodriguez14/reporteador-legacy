...
Public Class FrmConsignacionDimosa
        ...
        If VerificaEstado = "CONSIGNACION PEND" Then
            ...
            For j As Integer = 0 To grd_detalle.Rows.Count - 1
                ...
                Else
                    ...
                    datosProd = db.DatosProductoDIMOSA(grd_detalle.Rows(j).Cells("CODIGO").Value)
            ...
            If StatusCompleto = True Then
                Dim a = conex.COMPLETARDIMOSA(dt, dt2, _Inicio.lblUsuario.Text, Estado, txt_documento.Text, IdentidadConductor, Entregador, Placa, Modelo, TextClienteClave.Text, Vehiculo, EntregadorNumero)
                If a <> "correcto" Then
                    MsgBox("Error: " & a)
                Else
                    MsgBox("Remisión y factura generadas correctamente", MsgBoxStyle.Information, "Remisión Completada")
                    Frm_ListaConsignacionesDimosa.cargar()
                    Me.Close()
                End If
            End If
    ...
    Private Sub BtnCancelar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancelar.Click
        ...
        If VerificaEstado = "CONSIGNACION PEND" Then
            ...
            If StatusCompleto = True Then
                Dim a = conex.DEVOLVERDIMOSA(dt, dt2, _Inicio.lblUsuario.Text, Estado, txt_documento.Text)
                If a <> "correcto" Then
                    MsgBox("Error: " & a)
                Else
