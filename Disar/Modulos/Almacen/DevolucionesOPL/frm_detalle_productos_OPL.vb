Imports Disar.data
Public Class frm_detalle_productos_OPL
    ...
    Sub cargar()
        Try
            grd_detalle_productos.DataSource = conexion.lista_encabezados_devolucionesOPL(cmb_fecha.Value, txt_num_alma.Text,
    ...
    Private Sub btn_guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_guardar.Click
        Try
            ...
            Else
                ...
                variable_error = conexion.modificar_detalle_productosOPL(tabla_modificar, txt_cve_art.Text)
                ...
                If variable_error = "correcto" Then
                    ...
                    frm_devoluciones_ingresadas_OPL.cargar()

                    Dim conexion_bita As New cls_bitacora_reporteador
                    conexion_bita.RegistraBitacora(Now, _Inicio.lblUsuario.Text, "Modificacion Devoluciones desde Recepcion - OPL", "Almacen - Devoluciones - OPL",
                                              "Fecha: " + cmb_fecha.Value +
