...
Public Class frm_carga_devos_OPL
    ...
    Sub cargar_entregador()
        ...
        Try
            ComboEntregador.DataSource = db.Entregadores(cmb_sucursal.SelectedValue, "OPL")
    ...
    Sub cargar()
        Try
            'MsgBox("Cargando")
            grd_devos.DataSource = conexion.cargar_devos_entrega(cmb_fecha_ini.Value, "ENCABEZADO", ComboEntregador.SelectedValue, "OPL", "")
        ...
        Try
            ...
            Else
                ...
                For index As Integer = 0 To grd_devos.Rows.Count - 1
                    ...
                    dt_partidas = conexion.cargar_devos_entrega(cmb_fecha_ini.Value, "PARTIDAS", ComboEntregador.SelectedValue, "OPL", grd_devos.Rows(index).Cells(4).Value)

                    Dim variable_error As String = ""
                    variable_error = conexion.guardar_datos_local_aplicacion_android_OPL(dt_encabezado, dt_partidas, "OPL")
