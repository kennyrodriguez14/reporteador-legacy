...
Public Class Devoluciones_OPL
    ...
    Private Sub Devoluciones_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cmbsucursal.DataSource = Conexion.lista_de_sucursal_OPL()
    ...
    Sub Cargar()
        Try
            ...
            _griddevoluciones.DataSource = Conexion.Devoluciones_OPL(f1.Value.Date, f2.Value.Date, "DEVO" & cmbsucursal.SelectedValue.ToString)
            _gridAdicionales.DataSource = Conexion.Devoluciones_OPL(f1.Value.Date, f2.Value.Date, "ADICIONALES_" & cmbsucursal.SelectedValue.ToString)
