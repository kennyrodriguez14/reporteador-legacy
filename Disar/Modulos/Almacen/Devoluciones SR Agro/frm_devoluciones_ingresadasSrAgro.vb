...
Public Class frm_devoluciones_ingresadasSrAgro
    ...
    Private Sub frm_devoluciones_ingresadas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            dt = DB.EnviaDevoluciones(_Inicio.lblUsuario.Text, "SR AGRO")
            If dt(0)(0) = 1 Then
    ...
    Sub cargar()
        Try
            grd_encabezados_contado.DataSource = conexion.lista_encabezados_devoluciones(cmb_fecha_ini.Value, cmb_sucursal.SelectedValue, _
                                                    "FILTRO_ALMACEN", documento, documento2, "")

            grd_reporte_carga.DataSource = conexion.lista_encabezados_devoluciones(cmb_fecha_ini.Value, cmb_sucursal.SelectedValue, _
    ...
    Private Sub grd_reporte_carga_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles grd_reporte_carga.DoubleClick
        frm_detalle_productos.Close()
        frm_detalle_productos.txt_factura_inicial.Text = documento
        frm_detalle_productos.txt_factura_final.Text = documento2
        frm_detalle_productos.txt_num_alma.Text = cmb_sucursal.SelectedValue
        frm_detalle_productos.txt_almacen.Text = cmb_sucursal.Text
        frm_detalle_productos.cmb_fecha.Value = cmb_fecha_ini.Value
        frm_detalle_productos.txt_cve_art.Text = grd_reporte_carga.CurrentRow.Cells(0).Value
        frm_detalle_productos.txt_producto.Text = grd_reporte_carga.CurrentRow.Cells(1).Value
        frm_detalle_productos.ShowDialog()
    End Sub

    Private Sub btn_enviar_sae_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_enviar_sae.Click
        Try
            If conexion.validar_devos_enviadas(cmb_sucursal.SelectedValue, cmb_fecha_ini.Value.Date _
            ...
            Else
                ...
                variable_error = conexion.guardar_recepcion_SAE(tabla_devos, documento, documento2, cmb_fecha_ini.Value, cmb_sucursal.SelectedValue, _Inicio.lblUsuario.Text)
                ...
                If variable_error = "correcto" Then
                    ...
                    Dim conexion_bita As New cls_bitacora_reporteador
                    conexion_bita.RegistraBitacora(Now, _Inicio.lblUsuario.Text, "Realizo envio a SAE", "Almacen - Devoluciones", _
                                              "Fecha: " + cmb_fecha_ini.Value + _
                                              " Facturas: " + txt_factura_inicial.Text + " - " + txt_factura_final.Text)
                    Me.Close()
                Else
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            grd_liquidacion_contado.DataSource = conexion.lista_encabezados_devoluciones(cmb_fecha_ini.Value, cmb_sucursal.SelectedValue, _
                                                   "REPORTE_LIQUIDACION_CONTADO", documento, documento2, "")

            grd_liquidacion_credito.DataSource = conexion.lista_encabezados_devoluciones(cmb_fecha_ini.Value, cmb_sucursal.SelectedValue, _
            ...
            Dim conexion_bita As New cls_bitacora_reporteador
            conexion_bita.RegistraBitacora(Now, _Inicio.lblUsuario.Text, "Genero Reporte de Carga para Liquidacion", "Almacen - Devoluciones", _
                                      "Fecha: " + cmb_fecha_ini.Value + _
                                      " Facturas: " + txt_factura_inicial.Text + " - " + txt_factura_final.Text)
    ...
    Sub ExportePDF()
        ...
        Using stream As New FileStream(direccion_archivo & "REPORTE DE LIQUIDACION DE " + txt_factura_inicial.Text + " A " + txt_factura_final.Text + ".pdf", FileMode.Create)
            ...
            logo = Image.GetInstance(recurso & "\Resources\Disar Logo-26.jpg")
