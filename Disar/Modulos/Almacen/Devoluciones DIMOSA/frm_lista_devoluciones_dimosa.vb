Imports Disar.data
Public Class frm_lista_devoluciones_dimosa
    Dim conexion As New cls_devoluciones
    Private Sub btn_nuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_nuevo.Click
        frm_nueva_devolucion_dimosa.Close()
        frm_nueva_devolucion_dimosa.modo = "ins"
        frm_nueva_devolucion_dimosa.ShowDialog()
        cargar()
    End Sub
    ...
    Private Sub btn_modificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_modificar.Click
        ...
        If grd_lista_devoluciones.RowCount > 0 Then
            frm_nueva_devolucion_dimosa.Close()
            frm_nueva_devolucion_dimosa.modo = "visualice"
            frm_nueva_devolucion_dimosa.num_reg = grd_lista_devoluciones.CurrentRow.Cells(0).Value
            frm_nueva_devolucion_dimosa.txt_codigo_cliente.Text = grd_lista_devoluciones.CurrentRow.Cells(3).Value
            frm_nueva_devolucion_dimosa.txt_nombre_cliente.Text = grd_lista_devoluciones.CurrentRow.Cells(4).Value
            frm_nueva_devolucion_dimosa.txt_tipo.Text = grd_lista_devoluciones.CurrentRow.Cells(5).Value
            frm_nueva_devolucion_dimosa.txt_codigo_vendedor.Text = grd_lista_devoluciones.CurrentRow.Cells(6).Value
            frm_nueva_devolucion_dimosa.txt_numero_factura.Text = grd_lista_devoluciones.CurrentRow.Cells(1).Value
            frm_nueva_devolucion_dimosa.cmb_concepto.SelectedValue = grd_lista_devoluciones.CurrentRow.Cells(10).Value
            frm_nueva_devolucion_dimosa.txt_codigo_entregador.Text = grd_lista_devoluciones.CurrentRow.Cells(11).Value
            frm_nueva_devolucion_dimosa.txt_entregador.Text = grd_lista_devoluciones.CurrentRow.Cells(12).Value
            frm_nueva_devolucion_dimosa.txt_vehiculo.Text = grd_lista_devoluciones.CurrentRow.Cells(13).Value

            frm_nueva_devolucion_dimosa.grp_ingreso_datos.Enabled = False
            frm_nueva_devolucion_dimosa.ShowDialog()
        End If
        ...
        Try
            ...
            Else
                If MessageBox.Show("¿Desea Eliminar la Devolucion " + grd_lista_devoluciones.CurrentRow.Cells(0).Value, "Confirmacion", _
                    ...
                    variable_error = conexion.eliminar_devolucionDimosa(grd_lista_devoluciones.CurrentRow.Cells(0).Value)
                    ...
                    If variable_error = "correcto" Then
                        ...
                        conexion_bita.RegistraBitacora(Now, _Inicio.lblUsuario.Text, "Elimino Devolucion DIMOSA ", "Almacen - Devoluciones - DIMOSA ", _
    ...
    Sub cargar()
        Try
            grd_lista_devoluciones.DataSource = conexion.lista_encabezados_devolucionesDimosa(cmb_fecha_ini.Value, _
    ...
    Private Sub mnu_carga_entregadores_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnu_carga_entregadores.Click
        frm_carga_devos_dimosa.Close()
        frm_carga_devos_dimosa.ShowDialog()
    End Sub
End Class