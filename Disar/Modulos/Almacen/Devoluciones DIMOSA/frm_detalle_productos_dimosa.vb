Imports Disar.data
Public Class frm_detalle_productos_dimosa
    ...
    Sub cargar()
        Try
            grd_detalle_productos.DataSource = conexion.lista_encabezados_devolucionesDimosa(cmb_fecha.Value, txt_num_alma.Text, _
    ...
    Private Sub btn_guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_guardar.Click
        Try
            ...
            Else
                ...
                variable_error = conexion.modificar_detalle_productosDimosa(tabla_modificar, txt_cve_art.Text)
                ...
                If variable_error = "correcto" Then
                    ...
                    frm_devoluciones_ingresadas_dimosa.cargar()

                    Dim conexion_bita As New cls_bitacora_reporteador
                    conexion_bita.RegistraBitacora(Now, _Inicio.lblUsuario.Text, "Modificacion Devoluciones desde Recepcion - DIMOSA", "Almacen - Devoluciones - DIMOSA", _
