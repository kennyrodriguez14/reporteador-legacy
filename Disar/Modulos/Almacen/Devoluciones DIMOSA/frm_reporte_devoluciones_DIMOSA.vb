...
Public Class frm_reporte_devoluciones_dimosa
    ...
    Private Sub btn_aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_aceptar.Click
        Try
            cargar_correlativos()
            grd_reporte.DataSource = conexion.lista_encabezados_devolucionesDimosa(cmb_fecha_ini.Value, cmb_sucursal.SelectedValue, _
