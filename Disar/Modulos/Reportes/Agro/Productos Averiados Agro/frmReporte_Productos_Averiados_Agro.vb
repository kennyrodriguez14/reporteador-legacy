Imports Disar.data
Public Class frmReporte_Productos_Averiados_Agro
    Dim conexion As New cls_reporte_de_productos_averiados_agro
    Dim style As Microsoft.Office.Interop.Excel.Style
    Dim ambos_almacenes As New cls_almacen

    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            grdReporte.DataSource = conexion.Reporte(cmFechaIni.Value.Date, cmbFin.Value.Date, cmb_almacen.SelectedValue)
    ...
    Private Sub frmReporte_Productos_Averiados_Agro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Cargar_almacen()
    End Sub

    Sub Cargar_almacen()
        cmb_almacen.DataSource = ambos_almacenes.get_almacen_Agro
