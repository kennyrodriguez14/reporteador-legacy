...
Public Class VentasporProveedorAgro
    ...
    Private Sub _btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _btnGenerar.Click
        ...
        DT = Conexion.GenerarDatosAgro(Fi1, Ff1, Fi2, Ff2, Fi3, Ff3, "lista_almacenes", DiasTrabajados, DiasMes - Domingos, 0)
        ...
        For a As Integer = 0 To DT.Rows.Count - 1
            ...
            Tablita1.DataSource = Conexion.GenerarDatosAgro(Fi1, Ff1, Fi2, Ff2, Fi3, Ff3, "SUC", DiasTrabajados, DiasMes - Domingos, DT(a)(0))
