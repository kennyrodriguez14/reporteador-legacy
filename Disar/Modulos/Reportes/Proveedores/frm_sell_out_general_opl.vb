Imports Disar.data
Imports System.IO
Public Class frm_sell_out_general_opl
    ...
    Sub llenar_cmb()
        cmb_linea.DataSource = conexion.Llenar_cmb_opl()
    ...
    Private Sub _btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _btnGenerar.Click
        Try
            GridGeneral.DataSource = conexion.getDatosOPL(f1.Value.Date, f2.Value.Date, cmb_linea.SelectedValue)
    ...
    Sub exportarTXT(ByVal Ruta As String)
        Dim sFile As String = Ruta & "\Sell_Out_General_OPL" & Now.Day & "-" & Now.Month & "-" & Now.Year & ".xls "
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        frmGuardarArchivo.Formulario = "sell_out_general_OPL"
