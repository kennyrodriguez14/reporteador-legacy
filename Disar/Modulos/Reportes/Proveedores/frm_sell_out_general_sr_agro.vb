Imports Disar.data
Imports System.IO
Public Class frm_sell_out_general_sr_agro
    ...
    Private Sub _btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _btnGenerar.Click
        Try
            GridGeneral.DataSource = conexion.getSellOutSRAGRO(f1.Value.Date, f2.Value.Date, cmb_linea.SelectedValue)
        ...
        Try
            ...
            With GridGeneral
                ...
                _Line = .Columns(0).HeaderText & vbTab &
                            ...
                            .Columns(28).HeaderText & vbTab &
                            .Columns(29).HeaderText
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        frmGuardarArchivo.Formulario = "sell_out_general_SRAGRO"
        frmGuardarArchivo.MdiParent = _Inicio
        frmGuardarArchivo.Visible = True
    End Sub

    Private Sub frm_sell_out_general_sr_agro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        llenar_cmb()
    End Sub
