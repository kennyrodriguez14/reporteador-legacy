Imports Disar.data
Public Class frm_reporte_contado_credito
    Dim style As Microsoft.Office.Interop.Excel.Style
    Dim conexion As New cls_ventas_contado_credito
    Dim Clase As New cls_reporte_carga
    Private Sub frm_reporte_contado_credito_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Cargar_Almacen()
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            grdReporte.DataSource = conexion.Reporte(cmFechaIni.Value.Date, DateTimePicker1.Value.Date, cmbAlmacen.SelectedValue)
        Catch ex As Exception
