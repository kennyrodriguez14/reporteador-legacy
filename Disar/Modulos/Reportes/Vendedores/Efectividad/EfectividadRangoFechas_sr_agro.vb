Imports Disar.data
Public Class EfectividadRangoFechas_sr_agro
    ...
    Dim _ListaVendedor As New _clsVendedoresSRAGRO
    
    Dim _VisitadosSRAGRO As New cls_efectividad_SRAGRO
    ...
    Sub SeleccionarSucursal()
        Clase_ListaVendedores = _ListaVendedor
        Clase_Efectivos = _VisitadosSRAGRO
    End Sub
