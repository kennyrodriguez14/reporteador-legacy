...
Public Class ReporteCarga
            ...
            Else
                Try
                    ...
                    For i As Integer = 0 To grdBodega.RowCount - 1
                        ...
                        If cmbSucursal.SelectedItem = "SR AGRO" Then
                            ...
                            '    DX = Clase.LOTESAGRO(grdBodega.Rows(i).Cells("CODIGO").Value, cmbAlmacen.SelectedValue)

                            '    Dim S As String = ""
                            '    Dim TOTAL As Decimal = 0

                            '    For a As Integer = 0 To DX.Rows.Count - 1
                            '        If TOTAL < 
                            '    Next
                    ...
                    For i As Integer = 0 To grdContado.RowCount - 1
                        ...
                        End If
                    Next
                    dinerocontado.Text = FormatNumber(dine, 2)
                    ...
                    For i As Integer = 0 To grdCredito.RowCount - 1
                        ...
                        End If
                    Next
                    dinerocredito.Text = FormatNumber(dine, 2)
                    ...
                    conexion_bita.RegistraBitacora(Now, _Inicio.lblUsuario.Text, "Genero Reporte de carga para liquidacion", "Supply Chain", _
    ...
    Sub Exportar()
        Try
            ...
            Else
                ...
                wSheet2.Cells(Cont2 + 1, 4).value = dinerocontado.Text
            ...
            Else
                ...
                wSheet3.Cells(Cont3 + 1, 4).value = dinerocredito.Text
    ...
    Sub ImprimirRemision_DISAR()
        ...
        tabla_transportista4.HorizontalAlignment = Element.ALIGN_CENTER
        tabla_transportista4.WidthPercentage = (500 / 5.1F)
        tabla_transportista4.SetWidths(New Integer() {1, 4, 1})
        tabla_transportista4.SpacingAfter = 20

        Dim tabla_grilla3


        If cmbSucursal.Text <> "SR AGRO" Then
            tabla_grilla3 = New PdfPTable(10)
        Else
            tabla_grilla3 = New PdfPTable(9)
        End If
        ...
        If cmbSucursal.Text <> "SR AGRO" Then
            tabla_grilla3.SetWidths(New Integer() {1, 2, 2, 6, 2, 1, 1, 2, 2, 2})
        Else
            tabla_grilla3.SetWidths(New Integer() {1, 2, 2, 6, 2, 1, 1, 2, 2})
        End If
        ...
        Using stream As New FileStream(direccion_archivo & "Reporte de Carga - Almacen " & cmbAlmacen.SelectedValue & " " & _txtDesde.Text & " a " & _txtHasta.Text & ".pdf", FileMode.Create)
            ...
            Try
                ...
                If Vendido.Date.DayOfWeek = 7 Then
                    Vendido = DateAdd(DateInterval.Day, -2, Facturado)
                End If

                If Entregado.Date.DayOfWeek = 7 Then
            ...
            tabla_sub_encabezado.AddCell(New Phrase("VENTA: " & Venta, FontFactory.GetFont("arial", 9, Font.Bold, Color.BLACK)))
            tabla_sub_encabezado.AddCell("")
            tabla_sub_encabezado.AddCell("")
            tabla_sub_encabezado.AddCell(New Phrase("RUTA: " & Ruta, FontFactory.GetFont("arial", 9, Font.Bold, Color.BLACK)))
            tabla_sub_encabezado.AddCell("")
            tabla_sub_encabezado.AddCell("")
            tabla_sub_encabezado.AddCell(New Phrase("VENDIDO: " & Vendido.Date & vbNewLine & "FACTURADO: " & Facturado.Date & vbNewLine & "ENTREGADO: " & Entregado.Date & vbNewLine, FontFactory.GetFont("arial", 9, Font.Bold, Color.BLACK)))
            tabla_sub_encabezado.AddCell(New Phrase(""))
            tabla_sub_encabezado.AddCell("")
            tabla_sub_encabezado.AddCell(New Phrase("Nº FACTURAS: " & _txtDesde.Text & " - " & _txtHasta.Text & vbNewLine & "ENTREGADOR: " & Entregador & vbNewLine & "VEHICULO:" & Vehiculo & vbNewLine & "PESO: " & Peso, FontFactory.GetFont("arial", 9, Font.Bold, Color.BLACK)))
            tabla_sub_encabezado.AddCell("")
            tabla_sub_encabezado.AddCell("")
            ...
            If CheckBox1.CheckState = CheckState.Checked Then
                ...
                tabla_grilla.AddCell(Cell_Interior)
            Else
                Cell_Interior = New PdfPCell(New Phrase(dinerocontado.Text, FontFactory.GetFont("arial", 8, Font.Bold, Color.BLACK)))
                Cell_Interior.BackgroundColor = Color.GRAY
                tabla_grilla.AddCell(Cell_Interior)
            End If
            ...
            If CheckBox1.CheckState = CheckState.Checked Then
                ...
                tabla_grilla2.AddCell(Cell_Interior)
            Else
                Cell_Interior = New PdfPCell(New Phrase(dinerocredito.Text, FontFactory.GetFont("arial", 8, Font.Bold, Color.BLACK)))
                Cell_Interior.BackgroundColor = Color.GRAY
                tabla_grilla2.AddCell(Cell_Interior)
            End If
            ...
            For i As Integer = 0 To grdBodega.RowCount - 1
                ...
                For j As Integer = 0 To grdBodega.ColumnCount - 1
                    ...
                    tabla_grilla3.AddCell(New Phrase(Convert.ToString(grdBodega.Rows(i).Cells(j).Value), FontFactory.GetFont("arial", 8, Font.Bold, Color.BLACK)))

                Next
            Next
            Dim cell_sangria_contenidoXX As New PdfPCell(New Phrase(""))
            cell_sangria_contenidoXX.BorderColor = Color.WHITE

            tabla_grilla3.AddCell(cell_sangria_contenidoXX)
            ...
            Dim cell4 As New PdfPCell(New Phrase("ENTREGA", FontFactory.GetFont("arial black", 11, Font.Bold, Color.BLACK)))
            cell4.BorderColor = Color.WHITE
            cell4.HorizontalAlignment = Element.ALIGN_CENTER
            tabla_transportista4.AddCell(cell4)
            tabla_transportista4.AddCell("")
    ...
    Private Sub cmbAlmacen_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbAlmacen.SelectedIndexChanged
        ...
        ElseIf cmbSucursal.SelectedItem = "SR AGRO" Then
            Try
                ...
                Dim Clase2 As New cls_reporte_carga_valorcero
                dt = Clase2.getFolioAgro(cmbAlmacen.SelectedValue)
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        If Activo <> 1 Then
            MsgBox("Todavía no se han generado datos", MsgBoxStyle.Exclamation, "Informacion Vacía")
        Else
            'Exportar()
            ExportarPDF()
        End If
    ...
    Private Sub _txtDesde_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles _txtDesde.KeyPress
        If Asc(e.KeyChar) = Keys.Enter Then
            desde()
        End If
    End Sub

    Private Sub _txtHasta_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles _txtHasta.KeyPress
        If Asc(e.KeyChar) = Keys.Enter Then
            hasta()
        End If
    End Sub
    ...
    Private Sub cmbFecha_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbFecha.ValueChanged
        If cmbAlmacen.SelectedValue = 3 Then
            If cmbFecha.Value <= Convert.ToDateTime("13/03/2018") Then
                folio_ini.Text = "02-001-01-"
                folio_fin.Text = "02-001-01-"
            Else
                folio_ini.Text = "04-001-01-"
