...
Public Class Devoluciones_Notas_De_Credito
    ...
    Sub Cargar()
        Try
            ...
            If cmbsucursal.SelectedItem = "SPS" Then
                ...
                _griddevoluciones.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "SPS")
                TotImporte = 0
                TotImpuesto = 0
                TotDescuento = 0
                TotDevoluciones = 0
            ...
            ElseIf cmbsucursal.SelectedItem = "SRC" Then
                _griddevoluciones.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "SRC")
                TotImporte = 0
                TotImpuesto = 0
                TotDescuento = 0
                TotDevoluciones = 0
            ...
            ElseIf cmbsucursal.SelectedItem = "Saba" Then
                _griddevoluciones.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "Tocoa")
                TotImporte = 0
                TotImpuesto = 0
                TotDescuento = 0
                TotDevoluciones = 0
            ...
            ElseIf cmbsucursal.SelectedItem = "Tegucigalpa" Then
                _griddevoluciones.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "Tegucigalpa")
                TotImporte = 0
                TotImpuesto = 0
                TotDescuento = 0
                TotDevoluciones = 0
            ...
            ElseIf cmbsucursal.SelectedItem = "Movil SRC" Then
                _griddevoluciones.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "Movil SRC")
            ...
            ElseIf cmbsucursal.SelectedItem = "Movil SPS" Then
                ...
                _griddevoluciones.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "Movil SPS")
                TotImporte = 0
                TotImpuesto = 0
                TotDescuento = 0
                TotDevoluciones = 0
            ...
            ElseIf cmbsucursal.SelectedItem = "Movil Saba" Then
                _griddevoluciones.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "Movil Tocoa")
                TotImporte = 0
                TotImpuesto = 0
                TotDescuento = 0
                TotDevoluciones = 0
            ...
            Else
                _griddevoluciones.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "AMBAS")
                TotImporte = 0
                TotImpuesto = 0
                TotDescuento = 0
                TotDevoluciones = 0
