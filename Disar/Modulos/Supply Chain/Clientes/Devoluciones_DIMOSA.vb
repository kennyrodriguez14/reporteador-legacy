Imports Disar.data
Public Class Devoluciones_DIMOSA
    ...
    Private Sub Devoluciones_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cmbsucursal.DataSource = Conexion.lista_de_sucursal_DIMOSA()
        cmbsucursal.ValueMember = "ID"
        cmbsucursal.DisplayMember = "DES"
    End Sub

    Sub Cargar()
        Try
            'MsgBox("DEVO" & cmbsucursal.SelectedValue.ToString & vbNewLine & "ADICIONALES_" & cmbsucursal.SelectedValue.ToString)
            _griddevoluciones.DataSource = Conexion.Devoluciones_dimosa(f1.Value.Date, f2.Value.Date, "DEVO" & cmbsucursal.SelectedValue.ToString)
            _gridAdicionales.DataSource = Conexion.Devoluciones_dimosa(f1.Value.Date, f2.Value.Date, "ADICIONALES_" & cmbsucursal.SelectedValue.ToString)

            'If cmbsucursal.SelectedItem = "SPS" Then
            '    _griddevoluciones.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "DEVOSPS")
            '    _gridAdicionales.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "ADICIONALES_SPS")
            'ElseIf cmbsucursal.SelectedItem = "SRC" Then
            '    _griddevoluciones.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "DEVOSRC")
            '    _gridAdicionales.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "ADICIONALES_SRC")
            'ElseIf cmbsucursal.SelectedItem = "Tocoa" Then
            '    _griddevoluciones.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "DEVOTocoa")
            '    _gridAdicionales.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "ADICIONALES_Tocoa")

            'ElseIf cmbsucursal.SelectedItem = "Movil SRC" Then
            '    _griddevoluciones.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "DEVOmsrc")
            '    _gridAdicionales.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "ADICIONALES_msrc")

            'ElseIf cmbsucursal.SelectedItem = "Movil SPS" Then
            '    _griddevoluciones.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "DEVOmsps")
            '    _gridAdicionales.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "ADICIONALES_msps")

            'ElseIf cmbsucursal.SelectedItem = "Movil Tocoa" Then
            '    _griddevoluciones.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "DEVOmtocoa")
            '    _gridAdicionales.DataSource = Conexion.Devoluciones(f1.Value.Date, f2.Value.Date, "ADICIONALES_mtocoa")
            'End If
            ...
            For i As Integer = 0 To _griddevoluciones.RowCount - 1
                D += _griddevoluciones.Rows(i).Cells("Devolucion").Value
            Next
