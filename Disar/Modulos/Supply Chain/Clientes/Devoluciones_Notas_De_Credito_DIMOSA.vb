...
Public Class Devoluciones_Notas_De_Credito_DIMOSA
    ...
    Sub ALMACENES()
        cmbsucursal.DataSource = Conexion.AlmacenesAA
    ...
    Sub Cargar()
        Try
            ...
            _griddevoluciones.DataSource = Conexion.DevolucionesDIMOSA(f1.Value.Date, f2.Value.Date, cmbsucursal.SelectedValue)
            TotImporte = 0
            TotImpuesto = 0
            TotDescuento = 0
            TotDevoluciones = 0
            ...
            '    _griddevoluciones.DataSource = Conexion.DevolucionesDIMOSA(f1.Value.Date, f2.Value.Date, "SRC")
            '    TotImporte = 0
            '    TotImpuesto = 0
            '    TotDescuento = 0
            '    TotDevoluciones = 0
            ...
            '    _griddevoluciones.DataSource = Conexion.DevolucionesDIMOSA(f1.Value.Date, f2.Value.Date, "Tocoa")
            '    TotImporte = 0
            '    TotImpuesto = 0
            '    TotDescuento = 0
            '    TotDevoluciones = 0
            ...
            '    _griddevoluciones.DataSource = Conexion.DevolucionesDIMOSA(f1.Value.Date, f2.Value.Date, "Tegucigalpa")
            '    TotImporte = 0
            '    TotImpuesto = 0
            '    TotDescuento = 0
            '    TotDevoluciones = 0
            ...
            'Else
            '    _griddevoluciones.DataSource = Conexion.DevolucionesDIMOSA(f1.Value.Date, f2.Value.Date, "AMBAS")
            '    TotImporte = 0
            '    TotImpuesto = 0
            '    TotDescuento = 0
            '    TotDevoluciones = 0
