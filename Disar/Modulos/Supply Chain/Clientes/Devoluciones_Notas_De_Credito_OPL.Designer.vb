...
Partial Class Devoluciones_Notas_De_Credito_OPL
    ...
    Private Sub InitializeComponent()
        ...
        Me.cmbsucursal.Items.AddRange(New Object() {"SPS", "SRC", "Saba", "Tegucigalpa", "AMBAS"})
        ...
        '
        'Devoluciones_Notas_De_Credito_OPL
        '
        ...
        Me.Name = "Devoluciones_Notas_De_Credito_OPL"
        Me.Text = "Devoluciones_Notas_De_Credito_OPL"
    ...
    Friend WithEvents lblDevoluviones As Label
    ...
    Friend WithEvents lblTotalImporte As Label
    Friend WithEvents lblImporte As Label
    Friend WithEvents LblNumeroRegistros As Label
