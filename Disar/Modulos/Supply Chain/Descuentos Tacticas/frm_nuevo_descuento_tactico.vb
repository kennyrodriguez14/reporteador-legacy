Imports Disar.data
Public Class frm_nuevo_descuento_tactico
    ...
    Private Sub btn_new_client_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_new_client.Click
        Try
            ...
            If frm_clientes.DialogResult = Windows.Forms.DialogResult.OK Then
                txt_codigo_cliente.Text = frm_clientes.codigo
                txt_nombre_cliente.Text = frm_clientes.cliente
                txt_codigo_vendedor.Text = frm_clientes.cve_vend
                txt_nombre_vendedor.Text = frm_clientes.vendedor
                txt_rfc.Text = frm_clientes.rfc
                txt_con_credito.Text = frm_clientes.pago
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
    ...
    Private Sub btn_facturas_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_facturas.Click
        Try
            ...
            Else
                frm_facturas2.Close()
                frm_facturas2.codigo = txt_codigo_cliente.Text
                frm_facturas2.con_credito = txt_con_credito.Text

                frm_facturas2.ShowDialog()
                If frm_facturas2.DialogResult = DialogResult.OK Then
                    txt_numero_factura.Text = frm_facturas2.factura
                    txt_tipo.Text = frm_facturas2.tipo
                    cmb_fecha_documento.Value = frm_facturas2.fecha
                    txt_fecha_entrega.Text = frm_facturas2.fecha_entrega
                    grd_productos.DataSource = conexion.productos_factura(txt_numero_factura.Text)
                    cmb_sucursal.SelectedValue = frm_facturas2.almacen
                End If
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message)
            ...
            Else
                ...
                Else
                    ...
                    If MessageBox.Show("Desea enviar el registro a SAE", "Confirmacion", MessageBoxButtons.YesNoCancel, _
                        ...
                        conexion_bita.RegistraBitacora(Now, _Inicio.lblUsuario.Text, "Genero Nota de Credito", "Supply Chain - Notas de Credito", _
    ...
    Private Sub btn_carga_producto_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_carga_producto.Click
        frm_productos_indivual.ShowDialog()
        txt_codigo_producto.Text = frm_productos_indivual.cve_art
        txt_nombre_producto.Text = frm_productos_indivual.producto
        txt_codigo_proveedor.Text = frm_productos_indivual.cve_prov
        txt_proveedor.Text = frm_productos_indivual.proveedor
        txt_isv.Text = frm_productos_indivual.isv
    End Sub
End Class