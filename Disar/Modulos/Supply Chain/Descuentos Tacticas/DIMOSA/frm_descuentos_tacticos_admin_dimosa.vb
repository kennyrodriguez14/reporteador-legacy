Imports Disar.data
Public Class frm_descuentos_tacticos_admin_dimosa
    Dim conexion As New cls_descuentos_tacticos
    Private Sub btn_aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_aceptar.Click
        Try
            grd_lista.DataSource = conexion.ListarDescuentos_administracion_dimosa(cmb_fecha_ini.Value, cmb_fecha_fin.Value, cmb_almacen.SelectedValue)
    ...
    Private Sub frm_descuentos_tacticos_admin_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_almacen()
    End Sub
