...
Public Class frm_resumen_des_tac_dimosa
    ...
    Sub cargar_almacenes()
        Try
            cmb_almacen.DataSource = conexion.ListarAlmacenes_para_resumen_dimosa
    ...
    Private Sub btn_aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_aceptar.Click
        Try
            grd_listado.DataSource = conexion.reporte_resumen_dimosa(cmb_fecha_inicial.Value, cmb_fecha_final.Value, cmb_almacen.SelectedValue)
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
    End Sub
    ...
    Private Sub btn_excel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_excel.Click
        ...
        frmGuardarArchivo.Formulario = "Resumen_Descuentos_Tacticos_Dimosa"
