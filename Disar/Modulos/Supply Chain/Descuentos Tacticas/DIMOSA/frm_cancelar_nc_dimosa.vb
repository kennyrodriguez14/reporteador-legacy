...
Public Class frm_cancelar_nc_dimosa
    ...
    Private Sub btn_cancelar_nc_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_cancelar_nc.Click
        Try
            ...
            dt_estado = conexion.get_estado_nc_dimosa(txt_nc.Text)
            ...
            If dt_estado.Rows(0)(0) <> "C" Then
                If MessageBox.Show("¿Desea Cancelar la NC del Cliente " + txt_cliente.Text + " ?", "Confirmacion", MessageBoxButtons.YesNoCancel, _
                    ...
                    resultado = conexion.eliminar_nc_sae_dimosa(txt_nc.Text, txt_cod_cliente.Text, txt_monto.Text, txt_codigo_local.Text, _
    ...
    Sub cargar_datos()
        Try
            ...
            ctlpol = conexion.listar_ctlpol_dimosa(txt_nc.Text)
            txt_ctlpol.Text = ctlpol
            If txt_ctlpol.Text = "0" Then
                txt_interface.Text = "No"
            Else
                txt_interface.Text = "Si"
                grd_facturas.DataSource = conexion.Listardoctos_pol_dimosa(txt_ctlpol.Text)
            End If

            grd_ctlpol.DataSource = conexion.Listarctlpol_dimosa(txt_ctlpol.Text)
            ...
            If grd_ctlpol.Rows.Count > 0 Then
                ...
                If txt_contabilizado.Text = "Si" Then
                    ...
                    dt_tabla_poliza_coi = conexion.seleccionar_poliza_coi_dimosa(num_poliza, txt_year.Text, txt_mes.Text, tipo_poliza)
        ...
        Try
            ...
            ctlpol_concepto31 = conexion.listar_ctlpol_concepto31_dimosa(txt_nc.Text, txt_cargo_por_dev.Text)
            txt_ctlpol_C31.Text = ctlpol_concepto31
            If txt_ctlpol_C31.Text = "0" Then
                txt_interface_C31.Text = "No"
            Else
                txt_interface_C31.Text = "Si"
                grd_facturas_C31.DataSource = conexion.Listardoctos_pol_C31_dimosa(txt_ctlpol_C31.Text)
            End If

            grd_ctlpol_C31.DataSource = conexion.Listarctlpol_dimosa(txt_ctlpol_C31.Text)
            ...
            If grd_ctlpol_C31.Rows.Count > 0 Then
                ...
                If txt_contabilizado_C31.Text = "Si" Then
                    ...
                    dt_tabla_poliza_coi_C31 = conexion.seleccionar_poliza_coi_dimosa(num_poliza_C31, txt_year_C31.Text, txt_mes_c31.Text, tipo_poliza_C31)
