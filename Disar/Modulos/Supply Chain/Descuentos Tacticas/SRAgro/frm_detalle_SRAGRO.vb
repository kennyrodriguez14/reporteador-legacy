Imports Disar.data
Public Class frm_detalle_SRAGRO
    Dim conexion As New cls_descuentos_tacticos_sragro
    Dim dt_adic As New DataTable
    Private Sub frm_detalle_SRAGRO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Dim dt2 As New DataTable
            dt2 = conexion.listar_partida(txt_num_registro.Text)
            dt_adic = conexion.listar_datos_adicionales(txt_num_registro.Text)
        ...
        Try
            ...
            If MessageBox.Show("Esta seguro de hacer el envio a SAE?", "Confirmacion", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) _
             = Windows.Forms.DialogResult.Yes Then
                ...
                variable_error = conexion.hacer_envio_sae(dt_encabezado, dt_partidas, dt_adic.Rows(0)(1), dt_parfactd, subtotal_general, isv_total, dt_adic.Rows(0)(2), dt_adic.Rows(0)(0), txt_num_registro.Text)
        ...
        Try
            If txt_estado.Text = "SIN ENVIAR" Then
                If MessageBox.Show("Desea Eliminar el descuento tactico con codigo " + _
                    ...
                    var_error = conexion.delete_descuento_tactico(txt_num_registro.Text, txt_fecha.Text)
    ...
    Private Sub btn_modifcar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_modifcar.Click
        frm_modificar_descuento_tactico_SRAGRO.Close()
        frm_modificar_descuento_tactico_SRAGRO.ShowDialog()
    End Sub
End Class