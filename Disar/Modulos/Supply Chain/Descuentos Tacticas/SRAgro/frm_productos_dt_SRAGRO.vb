Imports Disar.data
Public Class frm_productos_dt_SRAGRO
    ...
    Private Sub frm_productos_dt_SRAGRO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
