Imports Disar.data
Public Class frm_descuentos_tacticos_admin_SRAGRO
    Dim conexion As New cls_descuentos_tacticos_sragro
    Private Sub btn_aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_aceptar.Click
        Try
            grd_lista.DataSource = conexion.ListarDescuentos_administracion(cmb_fecha_ini.Value, cmb_fecha_fin.Value, cmb_almacen.SelectedValue)
    ...
    Private Sub frm_descuentos_tacticos_admin_SRAGRO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_almacen()
    End Sub
    ...
    Private Sub grp_filtros_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles grp_filtros.Enter

    End Sub

    Private Sub grp_descuentos_tacticos_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles grp_descuentos_tacticos.Enter
