Imports Disar.data
Public Class frm_nuevo_descuento_tactico_SRAGRO
    ...
    Private Sub frm_nuevo_descuento_tactico_SRAGRO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_sucursal()
        cargar_conceptos()
    ...
    Sub cargar_conceptos_proveedores()
        Try
            cmb_concepto_prov.DataSource = conexion.listar_conceptos_proveedor()
    ...
    Sub cargar_conceptos()
        Try
            cmb_concepto.DataSource = conexion.listar_conceptos
    ...
    Private Sub btn_new_client_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_new_client.Click
        Try
            frm_clientes_SRAGRO.Close()
            frm_clientes_SRAGRO.ShowDialog()

            If frm_clientes_SRAGRO.DialogResult = Windows.Forms.DialogResult.OK Then
                txt_codigo_cliente.Text = frm_clientes_SRAGRO.codigo
                txt_nombre_cliente.Text = frm_clientes_SRAGRO.cliente
                txt_codigo_vendedor.Text = frm_clientes_SRAGRO.cve_vend
                txt_nombre_vendedor.Text = frm_clientes_SRAGRO.vendedor
                txt_rfc.Text = frm_clientes_SRAGRO.rfc
                txt_con_credito.Text = frm_clientes_SRAGRO.pago
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
    ...
    Private Sub btn_facturas_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_facturas.Click
        Try
            frm_facturas_SRAGRO.Close()

            frm_facturas_SRAGRO.ShowDialog()
            If frm_facturas_SRAGRO.DialogResult = DialogResult.OK Then
                txt_numero_factura.Text = frm_facturas_SRAGRO.factura
                txt_tipo.Text = frm_facturas_SRAGRO.tipo
                cmb_fecha_documento.Value = frm_facturas_SRAGRO.fecha
                txt_fecha_entrega.Text = frm_facturas_SRAGRO.fecha_entrega
                grd_productos.DataSource = conexion.productos_factura(txt_numero_factura.Text)
                cmb_sucursal.SelectedValue = frm_facturas_SRAGRO.almacen
                txt_codigo_cliente.Text = frm_facturas_SRAGRO.codigo_cliente
                txt_nombre_cliente.Text = frm_facturas_SRAGRO.cliente
                txt_con_credito.Text = frm_facturas_SRAGRO.con_credito
                txt_codigo_vendedor.Text = frm_facturas_SRAGRO.codigo_vendedor
                txt_nombre_vendedor.Text = frm_facturas_SRAGRO.vendedor
    ...
    Private Sub btn_productos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If frm_productos_dt.DialogResult = Windows.Forms.DialogResult.OK Then
            txt_codigo_producto.Text = frm_productos_dt.cve_art
            txt_nombre_producto.Text = frm_productos_dt.producto
            txt_codigo_proveedor.Text = frm_productos_dt.cve_prov
            txt_proveedor.Text = frm_productos_dt.proveedor
        End If
    End Sub
    ...
    Private Sub btn_agregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_agregar.Click
        Try
            ...
            Else
                ...
                presupuesto_restante += conexion.Valor_Restante(txt_codigo_proveedor.Text, cmb_fecha_descuento_tactico.Value.Year, cmb_fecha_descuento_tactico.Value.Month)
                If (Val(txt_importe_sisv.Text) + cargado) > presupuesto_restante Then
                    MessageBox.Show("El valor excede el presupuesto asignado", "Validacion", MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
                Else
            ...
            Else
                ...
                Else
                    ...
                    If MessageBox.Show("Desea enviar el registro a SAE", "Confirmacion", MessageBoxButtons.YesNoCancel, _
                        ...
                        variable_error = conexion.guardar_datos_envio_sae(dt_encabezado, dt_partidas, txt_rfc.Text, dt_parfactd, subtotal_general, isv_total, txt_fecha_entrega.Text, cmb_fecha_documento.Value)
                    Else
                        variable_error = conexion.guardar_datos_local(dt_encabezado, dt_partidas, txt_rfc.Text, dt_parfactd, subtotal_general, isv_total, txt_fecha_entrega.Text, cmb_fecha_documento.Value)
                    End If
    ...
    Private Sub grp_ingreso_datos_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles grp_ingreso_datos.Enter, grp_productos_factura.Enter
    ...
    Private Sub cmb_concepto_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmb_concepto.SelectedIndexChanged
