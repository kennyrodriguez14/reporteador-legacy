Imports Disar.data
Public Class frm_descuentos_tacticos_admin_proveedor_SRAGRO
    ...
    Private Sub frm_descuentos_tacticos_admin_proveedor_SRAGRO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_almacen()
    End Sub
