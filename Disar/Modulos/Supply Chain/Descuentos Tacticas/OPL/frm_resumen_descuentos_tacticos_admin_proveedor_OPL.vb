Imports Disar.data
Public Class frm_resumen_descuentos_tacticos_admin_proveedor_opl
    Dim conexion As New cls_descuentos_tacticos
    Private Sub btn_aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_aceptar.Click
        Try
            grd_lista.DataSource = conexion.ListarDescuentos_administracion_concepto_proveedor_opl(cmb_fecha_ini.Value, cmb_fecha_fin.Value, cmb_almacen.SelectedValue)
