...
Public Class frm_facturas_OPL
    ...
    Private Sub Grd_lista_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles grd_lista.CellContentClick
    ...
    Private Sub Frm_facturas_OPL_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            cmb_folio.DataSource = conexion.folio_facturacionOPL()
        ...
        Try
            If con_credito = "S" Then
                grd_lista.DataSource = conexion.listar_facturasOPL(codigo)
            ElseIf con_credito = "devolucion" Then
                lbl_factura.Visible = True
                txt_numero_factura.Visible = True
                txt_numero_factura.Focus()
            Else
                grd_lista.DataSource = conexion.listar_facturas_top1_OPL(codigo)
            End If
            txt_numero_factura.Focus()
        Catch ex As Exception
            MessageBox.Show(ex.Message)
    ...
    Private Sub Grd_lista_DoubleClick(sender As Object, e As EventArgs) Handles grd_lista.DoubleClick
        Try
            If con_credito = "devolucion" Then
                ...
                Try
                    tabla_valida = cone_dev.Validar_devolucionesOPL(grd_lista.CurrentRow.Cells(0).Value)
    ...
    Private Sub Btn_aceptar_Click(sender As Object, e As EventArgs) Handles btn_aceptar.Click
        Try
            ...
            grd_lista.DataSource = conexion_devoluciones.listar_facturas_devolucionesOPL(documento)
    ...
    Private Sub Cmb_folio_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmb_folio.SelectedIndexChanged
        ...
        Else
            Try
                sucursal = conexion.folio_DocumentosFiscalesOPL(cmb_folio.Text)
