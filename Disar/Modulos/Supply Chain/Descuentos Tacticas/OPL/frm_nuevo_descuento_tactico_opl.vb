Imports Disar.data
Public Class frm_nuevo_descuento_tactico_opl
    ...
    Sub cargar_conceptos_proveedores()
        Try
            cmb_concepto_prov.DataSource = conexion.listar_conceptos_proveedor_opl()
    ...
    Sub cargar_conceptos()
        Try
            cmb_concepto.DataSource = conexion.listar_conceptos_opl
    ...
    Private Sub btn_new_client_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_new_client.Click
        Try
            frm_clientes_opl.Close()
            frm_clientes_opl.ShowDialog()

            If frm_clientes_opl.DialogResult = Windows.Forms.DialogResult.OK Then
                txt_codigo_cliente.Text = frm_clientes_opl.codigo
                txt_nombre_cliente.Text = frm_clientes_opl.cliente
                txt_codigo_vendedor.Text = frm_clientes_opl.cve_vend
                txt_nombre_vendedor.Text = frm_clientes_opl.vendedor
                txt_rfc.Text = frm_clientes_opl.rfc
                txt_con_credito.Text = frm_clientes_opl.pago
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
    ...
    Private Sub btn_facturas_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_facturas.Click
        Try
            ...
            Else
                frm_facturas_opl2.Close()
                frm_facturas_opl2.codigo = txt_codigo_cliente.Text
                frm_facturas_opl2.con_credito = txt_con_credito.Text
                frm_facturas_opl2.ShowDialog()
                If frm_facturas_opl2.DialogResult = DialogResult.OK Then
                    txt_numero_factura.Text = frm_facturas_opl2.factura
                    txt_tipo.Text = frm_facturas_opl2.tipo
                    cmb_fecha_documento.Value = frm_facturas_opl2.fecha
                    txt_fecha_entrega.Text = frm_facturas_opl2.fecha_entrega
                    grd_productos.DataSource = conexion.productos_factura_opl(txt_numero_factura.Text)
                    cmb_sucursal.SelectedValue = frm_facturas_opl2.almacen
                End If
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message)
    ...
    Private Sub btn_productos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        frm_productos_dt_OPL.Close()
        frm_productos_dt_OPL.ShowDialog()

        If frm_productos_dt_OPL.DialogResult = Windows.Forms.DialogResult.OK Then
            txt_codigo_producto.Text = frm_productos_dt_OPL.cve_art
            txt_nombre_producto.Text = frm_productos_dt_OPL.producto
            txt_codigo_proveedor.Text = frm_productos_dt_OPL.cve_prov
            txt_proveedor.Text = frm_productos_dt_OPL.proveedor
        End If
    End Sub
    ...
    Private Sub btn_agregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_agregar.Click
        Try
            ...
            Else
                ...
                presupuesto_restante += conexion.Valor_Restante_opl(txt_codigo_proveedor.Text, cmb_fecha_descuento_tactico.Value.Year, cmb_fecha_descuento_tactico.Value.Month)

                grd_ingreso.Rows.Add(txt_codigo_producto.Text, txt_nombre_producto.Text, txt_cantidad.Text,
                                 txt_importe_sisv.Text, txt_codigo_proveedor.Text, txt_proveedor.Text,
                                 cmb_concepto.SelectedValue, cmb_concepto.Text, txt_isv.Text, txt_subtotal_noisv.Text,
            ...
            Else
                ...
                Else
                    ...
                    For index As Integer = 0 To grd_ingreso.Rows.Count - 1
                        dt_partidas.Rows.Add(index + 1, grd_ingreso.Rows(index).Cells(0).Value, grd_ingreso.Rows(index).Cells(2).Value,
                    ...
                    dt_encabezado.Rows.Add(txt_codigo_vendedor.Text, txt_numero_factura.Text, txt_codigo_cliente.Text, cmb_sucursal.SelectedValue,
                    ...
                    If MessageBox.Show("Desea enviar el registro a SAE", "Confirmacion", MessageBoxButtons.YesNoCancel,
                                       MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                        variable_error = conexion.guardar_datos_envio_sae_opl(dt_encabezado, dt_partidas, txt_rfc.Text, dt_parfactd, subtotal_general, isv_total, txt_fecha_entrega.Text, cmb_fecha_documento.Value)
                        Dim conexion_bita As New cls_bitacora_reporteador
                        conexion_bita.RegistraBitacora(Now, _Inicio.lblUsuario.Text, "Genero Nota de Credito DIMOSA", "Supply Chain - Notas de Credito",
                                                  "Fecha: " + cmb_fecha_descuento_tactico.Value +
                                                  " Facturas: " + txt_numero_factura.Text)
                    Else
                        variable_error = conexion.guardar_datos_local_opl(dt_encabezado, dt_partidas, txt_rfc.Text, dt_parfactd, subtotal_general, isv_total, txt_fecha_entrega.Text, cmb_fecha_documento.Value)
                    End If
    ...
    Private Sub btn_carga_producto_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_carga_producto.Click
        frm_productos_individual_opl.ShowDialog()
        txt_codigo_producto.Text = frm_productos_individual_opl.cve_art
        txt_nombre_producto.Text = frm_productos_individual_opl.producto
        txt_codigo_proveedor.Text = frm_productos_individual_opl.cve_prov
        txt_proveedor.Text = frm_productos_individual_opl.proveedor
        txt_isv.Text = frm_productos_individual_opl.isv
    End Sub
End Class