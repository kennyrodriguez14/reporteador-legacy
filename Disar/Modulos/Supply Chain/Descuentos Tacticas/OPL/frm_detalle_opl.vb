...
Public Class frm_detalle_OPL
    ...
    Private Sub frm_detalle_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            dt2 = conexion.listar_partida_OPL(txt_num_registro.Text)
            dt_adic = conexion.listar_datos_adicionales_opl(txt_num_registro.Text)
            ...
            If MessageBox.Show("Esta seguro de hacer el envio a SAE?", "Confirmacion", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) _
             = Windows.Forms.DialogResult.Yes Then
                ...
                For index As Integer = 0 To grd_lista.Rows.Count - 1
                    dt_partidas.Rows.Add(index + 1, grd_lista.Rows(index).Cells(0).Value, grd_lista.Rows(index).Cells(1).Value,
                ...
                dt_encabezado.Rows.Add(txt_cve_vend.Text, txt_numero_factura.Text, txt_codigo_cliente.Text, Val(txt_num_alma.Text),
                ...
                variable_error = conexion.hacer_envio_sae_opl(dt_encabezado, dt_partidas, dt_adic.Rows(0)(1), dt_parfactd, subtotal_general, isv_total, dt_adic.Rows(0)(2), dt_adic.Rows(0)(0), txt_num_registro.Text)

                Dim conexion_bita As New cls_bitacora_reporteador
                conexion_bita.RegistraBitacora(Now, _Inicio.lblUsuario.Text, "Genero Nota de Credito OPL", "Almacen - Devoluciones",
    ...
    Private Sub btn_eliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_eliminar.Click
        Try
            If txt_estado.Text = "SIN ENVIAR" Then
                If MessageBox.Show("Desea Eliminar el descuento tactico con codigo " +
                               txt_num_registro.Text + " ?",
                              "Confirmacion", MessageBoxButtons.YesNoCancel,
                              MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                    Dim var_error As String = ""
                    var_error = conexion.delete_descuento_tactico_opl(txt_num_registro.Text, txt_fecha.Text)
    ...
    Private Sub btn_modifcar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_modifcar.Click
        frm_modificar_descuento_tactico_opl.Close()
        frm_modificar_descuento_tactico_opl.ShowDialog()
    End Sub
End Class