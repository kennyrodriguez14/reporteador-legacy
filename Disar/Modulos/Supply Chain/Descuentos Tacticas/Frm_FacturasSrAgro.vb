Imports Disar.data
Public Class Frm_FacturasSrAgro
    ...
    Dim conexion_devoluciones As New cls_devolucionesAgro
    ...
    Private Sub frm_facturas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            cmb_folio.DataSource = conexion.folio_facturacion()
        ...
        Try
            If con_credito = "S" Then
                grd_lista.DataSource = conexion.listar_facturas(codigo)
            ElseIf con_credito = "devolucion" Then
                lbl_factura.Visible = True
                txt_numero_factura.Visible = True
                txt_numero_factura.Focus()
            Else
                grd_lista.DataSource = conexion.listar_facturas_top1(codigo)
            End If
            txt_numero_factura.Focus()
        Catch ex As Exception
            MessageBox.Show(ex.Message)
    ...
    Private Sub grd_lista_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles grd_lista.DoubleClick
        Try
            If con_credito = "devolucion" Then
                ...
                Dim cone_dev As New cls_devolucionesAgro
                Try
                    tabla_valida = cone_dev.Validar_devoluciones(grd_lista.CurrentRow.Cells(0).Value)
    ...
    Private Sub btn_aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_aceptar.Click
        Try
            ...
            grd_lista.DataSource = conexion_devoluciones.listar_facturas_devoluciones(documento)
    ...
    Private Sub cmb_folio_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmb_folio.SelectedIndexChanged
        ...
        Else
            Try
                sucursal = conexion.folio_DocumentosFiscales(cmb_folio.Text)
