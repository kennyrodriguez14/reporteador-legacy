Imports Disar.data
Public Class Ventas_Totales_Producto
    ...
    Private Sub Ventas_Totales_Producto_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Sub Exportar()
        Try
            ...
            wSheet.Cells.Range("A7:D7").Value = "VENTAS POR PRODUCTO"
