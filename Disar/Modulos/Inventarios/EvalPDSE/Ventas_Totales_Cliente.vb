Imports Disar.data
Public Class Ventas_Totales_Cliente
    ...
    Private Sub _btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _btnGenerar.Click
        Try
            If cmbSucursal.SelectedItem = "CONSUMO" Then
                Reporte = "vxcanal_consumo"
            ElseIf cmbSucursal.SelectedItem = "SR AGRO" Then
                Reporte = "vxcanal_sragro"
            End If
            _gridgeneral.DataSource = Conexion.VentasTotProd(_cmbFechai.Value.Date, _cmbFechaf.Value.Date, Reporte, "")
    ...
    Sub Exportar()
        Try
            ...
            End If 'imagen en picturebox Picture1 formato .bmp 
            ...
            wSheet.Cells.Range("A7:F7").Merge()
            wSheet.Cells.Range("A7:F7").Value = "VENTAS POR CLIENTE"
            wSheet.Cells.Range("A7:F7").Font.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.White)
            wSheet.Cells.Range("A7:F7").Interior.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.Black)
            wSheet.Cells.Range("A7:F7").VerticalAlignment = Microsoft.Office.Interop.Excel.XlVAlign.xlVAlignCenter
            wSheet.Cells.Range("A7:F7").HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignCenter
            wSheet.Cells.Range("A7:F7").BorderAround(1, Microsoft.Office.Interop.Excel.XlBorderWeight.xlThin)
            wSheet.Cells.Range("A7:F7").Font.Bold = True
            wSheet.Cells.Range("E4").Value = "FECHA INICIAL"
            ...
            wSheet.Cells.Range("E4").VerticalAlignment = Microsoft.Office.Interop.Excel.XlVAlign.xlVAlignCenter
            wSheet.Cells.Range("E4").HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignCenter
            wSheet.Cells.Range("E4").Font.Bold = True
            wSheet.Cells.Range("F4").Value = _cmbFechai.Value.Date
            wSheet.Cells.Range("F4").BorderAround(1, Microsoft.Office.Interop.Excel.XlBorderWeight.xlThin)
            wSheet.Cells.Range("E5").Value = "FECHA FINAL"
            wSheet.Cells.Range("E5").Font.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.White)
            wSheet.Cells.Range("E5").Interior.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.Black)
            wSheet.Cells.Range("E5").VerticalAlignment = Microsoft.Office.Interop.Excel.XlVAlign.xlVAlignCenter
            wSheet.Cells.Range("E5").HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignCenter
            wSheet.Cells.Range("E5").Font.Bold = True
            wSheet.Cells.Range("F5").Value = _cmbFechaf.Value.Date
            wSheet.Cells.Range("F5").BorderAround(1, Microsoft.Office.Interop.Excel.XlBorderWeight.xlThin)
            wSheet.Cells.Range("A7").Select()
