...
Public Class frm_Inventarios_DIMOSA
    Dim Conexion As New cls_inventarios

    Sub Cargar()
        Try
            '   _gridInventarios.Columns.Clear()
            _gridInventarios.DataSource = Conexion.GenerarDatosDIMOSA(txtCodigo.Text, txtCodigo.Text.ToUpper, cmbsucursal.SelectedItem, cmbTbusqueda.SelectedItem)
