...
Public Class Multialmacen
    ...
    Private Sub Multialmacen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cmbsucursal.SelectedItem = "AMBOS"
    ...
    Private Sub cmbTbusqueda_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Sub Cargar()
        ...
        almacen = "AMBOS"
        If cmbsucursal.SelectedItem = "AMBOS" Then
            almacen = "AMBOS"
        End If
        ...
        If cmbsucursal.SelectedItem = "Saba" Then
            almacen = "3"
        End If


        If cmbsucursal.SelectedItem = "Tegucigalpa" Then
            almacen = "4"
        End If

        Try
            _gridmultialmacen.DataSource = Conexion.GenerarDatos(almacen, txtlinea.Text)
            formatearGrid()
