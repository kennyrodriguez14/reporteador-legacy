Imports Disar.data
Public Class frm_margenes_autorizados
    Dim conexion_notas_debito As New clsInventarios
    Public usuario_id As Integer
    Public usuario_name As String
    Dim precio_anterior As String = 0
    Private Sub frm_margenes_autorizados_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_proveedores()
        cargar()
    End Sub
        ...
        Try
            If txt_validador.Text = "ins" Then
                ...
                If var_error = "correcto" Then
                    MessageBox.Show("Margen actualizado")
                Else
                    MessageBox.Show("Error al actualizar Margen" + var_error)
                End If
            Else
                Dim var_error As String = ""
    ...
    Private Sub btn_eportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_eportar.Click
        Exportar()
    End Sub
