...
Public Class frm_punto_reorden_sr_agro_detalle
    Dim conexion As New cls_punto_reorden
    Private Sub btn_generar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_generar.Click
        Try
            grd_punto_reorden.DataSource = conexion.punto_reorden_sr_agro_detalle(cmb_fecha_fin.Value, txt_dias.Value)
    ...
    Sub Exportar()
        ...
        Try
            ...
            For index As Integer = 0 To grd_punto_reorden.Rows.Count - 1
                ...
                & grd_punto_reorden.Rows(index).Cells(12).Value & vbTab & grd_punto_reorden.Rows(index).Cells(13).Value & vbCr

                sData2dias += grd_punto_reorden.Rows(index).Cells(14).Value & vbCr
                sData3peso += grd_punto_reorden.Rows(index).Cells(15).Value & vbCr
            Next
