...
Public Class frm_nc_por_desc
    ...
    Sub cargar_serie()
        Try
            txt_folio.Text = conexion.reporte_nc_por_descuento_serie(cmb_almacen.SelectedValue, "SERIE", cmb_empresa.SelectedValue).Rows(0)(0)
        Catch ex As Exception
            txt_folio.Text = ""
        End Try
    End Sub
    ...
    Sub exportar()
        Try
            ...
            wSheet.Cells.Range("A1:I1").Value = "Distribuidora San Rafael, S. de R. L. de C. V. (SAN RAFAEL)"
            wSheet.Cells.Range("A1:I1").Style = "NewStyle"
            'wSheet.Cells.Range("A1:I1").Borders.LineStyle = BorderStyle.FixedSingle

            wSheet.Cells.Range("A2:I2").Merge()
            wSheet.Cells.Range("A2:I2").Value = "Telefono: 2509-0007"
            wSheet.Cells.Range("A2:I2").Style = "NewStyle"
            'wSheet.Cells.Range("A2:I2").Borders.LineStyle = BorderStyle.FixedSingle

            wSheet.Cells.Range("A3:I3").Merge()
            wSheet.Cells.Range("A3:I3").Value = "info@disarhn.com"
            wSheet.Cells.Range("A3:I3").Style = "NewStyle"
            'wSheet.Cells.Range("A3:I3").Borders.LineStyle = BorderStyle.FixedSingle

            wSheet.Cells.Range("A4:I4").Merge()
            wSheet.Cells.Range("A4:I4").Value = "RTN: 05019017934322"
            wSheet.Cells.Range("A4:I4").Style = "NewStyle"
            'wSheet.Cells.Range("A4:I4").Borders.LineStyle = BorderStyle.FixedSingle

            wSheet.Cells.Range("A5:I5").Merge()
            wSheet.Cells.Range("A5:I5").Value = "Reporte de Notas de Credito por Descuentos fecha: " + cmb_fecha.Value.Date
            wSheet.Cells.Range("A5:I5").Style = "NewStyle"
            ...
            For index As Integer = 0 To grd_lista.Rows.Count - 1
                ...
                total += grd_lista.Rows(index).Cells("Total NC").Value
            Next
    ...
    Private Sub btn_aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_aceptar.Click
        Try
            ...
            grd_lista.DataSource = conexion.reporte_nc_por_descuento(txt_folio.Text + txt_ceros.Text + txt_inicio.Text, txt_folio.Text + txt_ceros.Text + txt_fin.Text, _
