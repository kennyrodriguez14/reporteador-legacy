Imports Disar.data
Public Class frm_Resumen_Costos_Agro
    Dim conexion As New clsResumen_costos_Agro

    Private Sub frm_Resumen_Costos_Agro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cmbSucursal.DataSource = conexion.Almacenes()
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        Try
            ...
            grd_costos.DataSource = conexion.Resumen_Costos(cmb_F1.Value.Date, cmb_f2.Value.Date, cmbSucursal.SelectedValue)
            limpiar()
