Imports Disar.data
Public Class frm_Resumen_Costos_opl
    Dim conexion As New clsResumen_costos

    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        Try

            grd_costos.DataSource = conexion.Resumen_CostosOPL(cmb_F1.Value.Date, cmb_f2.Value.Date, cmbSucursal.SelectedValue)
            limpiar()
    ...
    Private Sub frm_Resumen_Costos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cmbSucursal.DataSource = conexion.AlmacenesOPL()
